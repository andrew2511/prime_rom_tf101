...
.method performRestore([Landroid/app/backup/RestoreSet;)Z
    ...
    const-string v6, "No restore sets found"
...
.method prepareRestore(Landroid/content/Context;)Z
    ...
    iput-object v4, p0, Lcom/google/android/backup/BeginBackupService;->mRestoreSession:Landroid/app/backup/RestoreSession;
    ...
    .line 80
    iget-object v4, p0, Lcom/google/android/backup/BeginBackupService;->mRestoreSession:Landroid/app/backup/RestoreSession;

    if-nez v4, :cond_4

    .line 81
    sget-boolean v4, Lcom/google/android/backup/BeginBackupService;->LOCAL_LOGV:Z

    if-eqz v4, :cond_0

    const-string v4, "BackupTransportService"

    const-string v5, "No restore session"
    ...
    iget-object v5, p0, Lcom/google/android/backup/BeginBackupService;->mRestoreObserver:Landroid/app/backup/RestoreObserver;

    invoke-virtual {v4, v5}, Landroid/app/backup/RestoreSession;->getAvailableRestoreSets(Landroid/app/backup/RestoreObserver;)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v5, "Unable to contact server for restore"
    ...
    const-string v5, "error starting restore"

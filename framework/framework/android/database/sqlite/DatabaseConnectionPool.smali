...
.method isDatabaseObjFree(Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .end local p0
    check-cast p0, Landroid/database/sqlite/DatabaseConnectionPool$PoolObj;

    #calls: Landroid/database/sqlite/DatabaseConnectionPool$PoolObj;->isFree()Z
    invoke-static {p0}, Landroid/database/sqlite/DatabaseConnectionPool$PoolObj;->access$100(Landroid/database/sqlite/DatabaseConnectionPool$PoolObj;)Z
...
.method declared-synchronized release(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_c3
    .catchall {:try_start_1c .. :try_end_c3} :catchall_19

...
.method public executeMessage(Landroid/os/Message;)V
    ...
    iget-object v8, v0, Lcom/android/internal/os/HandlerCaller$SomeArgs;->arg3:Ljava/lang/Object;

    check-cast v8, [Ljava/lang/String;

    check-cast v8, [Ljava/lang/String;

    invoke-virtual {v6, p0, v7, v8}, Landroid/inputmethodservice/AbstractInputMethodService;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    :try_end_6a
    ...
    new-instance v7, Lcom/android/internal/view/InputConnectionWrapper;

    invoke-direct {v7, v4}, Lcom/android/internal/view/InputConnectionWrapper;-><init>(Lcom/android/internal/view/IInputContext;)V
    ...
    .end local v4           #inputContext:Lcom/android/internal/view/IInputContext;
    :sswitch_ea
    new-instance v7, Landroid/inputmethodservice/IInputMethodWrapper$InputMethodSessionCallbackWrapper;
    ...
    invoke-direct {v7, v8, p0}, Landroid/inputmethodservice/IInputMethodWrapper$InputMethodSessionCallbackWrapper;-><init>(Landroid/content/Context;Lcom/android/internal/view/IInputMethodCallback;)V

    invoke-interface {v5, v7}, Landroid/view/inputmethod/InputMethod;->createSession(Landroid/view/inputmethod/InputMethod$SessionCallback;)V
    ...
    :goto_105
    invoke-interface {v5, p0, v7}, Landroid/view/inputmethod/InputMethod;->setSessionEnabled(Landroid/view/inputmethod/InputMethodSession;Z)V
    ...
    invoke-interface {v5, v7, p0}, Landroid/view/inputmethod/InputMethod;->showSoftInput(ILandroid/os/ResultReceiver;)V
    ...
    invoke-interface {v5, v7, p0}, Landroid/view/inputmethod/InputMethod;->hideSoftInput(ILandroid/os/ResultReceiver;)V
    ...
    invoke-interface {v5, p0}, Landroid/view/inputmethod/InputMethod;->changeInputMethodSubtype(Landroid/view/inputmethod/InputMethodSubtype;)V

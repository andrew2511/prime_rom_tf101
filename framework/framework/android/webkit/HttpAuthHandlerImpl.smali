...
.method private processNextLoader()V
    ...
    .line 255
    iget-object v5, p0, Landroid/webkit/HttpAuthHandlerImpl;->mRequestInFlightLock:Ljava/lang/Object;

    monitor-enter v5

    .line 256
    :try_start_14
    sget-boolean v6, Landroid/webkit/HttpAuthHandlerImpl;->$assertionsDisabled:Z

    if-nez v6, :cond_28

    iget-boolean v6, p0, Landroid/webkit/HttpAuthHandlerImpl;->mRequestInFlight:Z
    ...
    :try_start_29
    iput-boolean v6, p0, Landroid/webkit/HttpAuthHandlerImpl;->mRequestInFlight:Z
...
.method private signalRequestComplete()V
    ...
    :try_start_15
    iput-boolean v1, p0, Landroid/webkit/HttpAuthHandlerImpl;->mRequestInFlight:Z
...
.method private waitForRequestToComplete()V
    ...
    :goto_3
    :try_start_3
    iget-boolean v2, p0, Landroid/webkit/HttpAuthHandlerImpl;->mRequestInFlight:Z
    :try_end_5
...
.method handleAuthRequest(Landroid/webkit/LoadListener;)V
    ...
    .line 208
    :try_start_1c
    sget-boolean v2, Landroid/webkit/HttpAuthHandlerImpl;->$assertionsDisabled:Z

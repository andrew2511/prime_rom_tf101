...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->mBackgroundId:I
...
.method private onAuthenticationFailure()V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->trySetBackground(I)V
...
.method private onBackButtonPressed()V
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->trySetBackground(I)V
...
.method private refreshAccessPoints(Z)V
    ...
    .line 731
    iget-object v1, p0, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->mPreviousNetworkState:Landroid/net/NetworkInfo$DetailedState;

    invoke-static {p0, v1}, Lcom/android/settings/wifi/Summary;->get(Landroid/content/Context;Landroid/net/NetworkInfo$DetailedState;)Ljava/lang/String;
    ...
    .line 737
    iget-object v1, p0, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {v1}, Lcom/android/settings/wifi/WifiSettings;->refreshAccessPoints()V
...
.method private showConnectedState()V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->trySetBackground(I)V
...
.method private trySetBackground(I)V
    ...
    .prologue
    .line 843
    iget v0, p0, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->mBackgroundId:I

    if-eq v0, p1, :cond_0

    .line 844
    invoke-virtual {p0}, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->getWindow()Landroid/view/Window;

    move-result-object v0

    invoke-virtual {p0}, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->getResources()Landroid/content/res/Resources;
    ...
    .line 845
    iput p1, p0, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->mBackgroundId:I
...
.method initSecurityFields(Landroid/view/View;I)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/wifi/WifiConfigUiForSetupWizardXL;->requestFocusAndShowKeyboard(I)V
...
.method onAccessPointsUpdated(Landroid/preference/PreferenceCategory;Ljava/util/Collection;)V
    .locals 5
    .parameter "holder"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
...
.method showConfigUi(Lcom/android/settings/wifi/AccessPoint;Z)V
    ...
    .line 455
    iput v4, p0, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->mScreenState:I

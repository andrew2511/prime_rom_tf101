...
.method private checkSchedule()Z
    ...
    const-string v5, "system was upgraded"

    invoke-static {v0, v5}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 313
    :cond_1
    invoke-virtual {v3, v11, v12}, Lcom/android/common/OperationScheduler;->setTriggerTimeMillis(J)V
    ...
    const-string v7, "subscriberid changed to "
    ...
    iput-wide v6, v5, Lcom/android/common/OperationScheduler$Options;->minTriggerMillis:J
    ...
    invoke-static {v4, v0, v8, v9}, Lcom/google/android/gsf/Gservices;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J

    move-result-wide v8

    mul-long/2addr v6, v8

    iput-wide v6, v5, Lcom/android/common/OperationScheduler$Options;->periodicIntervalMillis:J
    ...
    invoke-virtual {v3}, Lcom/android/common/OperationScheduler;->toString()Ljava/lang/String;
    ...
    .line 339
    invoke-virtual {v3, v5}, Lcom/android/common/OperationScheduler;->getNextTimeMillis(Lcom/android/common/OperationScheduler$Options;)J
...
.method private handleResponse(Lcom/google/common/io/protocol/ProtoBuf;)V
    ...
    const-string v8, "checkin succeeded"
...
.method public static wasSystemUpgraded(Landroid/content/Context;)Z
    ...
    .line 369
    sget-boolean v2, Lcom/google/android/gsf/checkin/CheckinService;->sSystemWasUpgraded:Z
    ...
    .line 382
    :cond_1
    sput-boolean v4, Lcom/google/android/gsf/checkin/CheckinService;->sSystemWasUpgraded:Z
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 152
    :cond_0
    const-class v0, Lcom/google/android/gsf/checkin/CheckinService;

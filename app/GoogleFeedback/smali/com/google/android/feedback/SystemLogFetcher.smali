...
.method public static declared-synchronized fetch()V
    ...
    .prologue
    .line 72
    const-class v0, Lcom/google/android/feedback/SystemLogFetcher;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/google/android/feedback/SystemLogFetcher;->mFetcherThread:Lcom/google/android/feedback/SystemLogFetcher$FetcherThread;

    if-nez v1, :cond_0

    .line 73
    new-instance v1, Lcom/google/android/feedback/SystemLogFetcher$FetcherThread;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lcom/google/android/feedback/SystemLogFetcher$FetcherThread;-><init>(Lcom/google/android/feedback/SystemLogFetcher$1;)V

    sput-object v1, Lcom/google/android/feedback/SystemLogFetcher;->mFetcherThread:Lcom/google/android/feedback/SystemLogFetcher$FetcherThread;

    .line 74
    sget-object v1, Lcom/google/android/feedback/SystemLogFetcher;->mFetcherThread:Lcom/google/android/feedback/SystemLogFetcher$FetcherThread;

    invoke-virtual {v1}, Lcom/google/android/feedback/SystemLogFetcher$FetcherThread;->start()V

    .line 76
    sget-object v1, Lcom/google/android/feedback/SystemLogFetcher;->mHandler:Landroid/os/Handler;

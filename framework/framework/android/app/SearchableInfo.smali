...
.method private static createActivityContext(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Context;
    ...
    .catch Ljava/lang/SecurityException; {:try_start_1 .. :try_end_9} :catch_2a
...
.method private static getActivityMetaData(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/ComponentName;)Landroid/app/SearchableInfo;
    ...
    :try_end_d
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_a .. :try_end_d} :catch_b3
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_d} :catch_d4
    ...
    const-string/jumbo v8, "searchable"
    ...
    :try_end_25
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_15 .. :try_end_25} :catch_fd
    .catch Ljava/io/IOException; {:try_start_15 .. :try_end_25} :catch_f9
    ...
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_28 .. :try_end_2d} :catch_fd
    .catch Ljava/io/IOException; {:try_start_28 .. :try_end_2d} :catch_f9
    ...
    invoke-interface {p1}, Lorg/xmlpull/v1/XmlPullParser;->next()I
    :try_end_30
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2d .. :try_end_30} :catch_b3
    ...
    invoke-static {p1}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    :try_end_76
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_35 .. :try_end_76} :catch_fd
    .catch Ljava/io/IOException; {:try_start_35 .. :try_end_76} :catch_f9
    ...
    :try_end_81
    .catch Ljava/lang/IllegalArgumentException; {:try_start_79 .. :try_end_81} :catch_83
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_79 .. :try_end_81} :catch_fd
    .catch Ljava/io/IOException; {:try_start_79 .. :try_end_81} :catch_f9
    ...
    invoke-static {v7, v8}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_af
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_85 .. :try_end_af} :catch_fd
    .catch Ljava/io/IOException; {:try_start_85 .. :try_end_af} :catch_f9
    ...
    const-string v9, "Reading searchable metadata for "

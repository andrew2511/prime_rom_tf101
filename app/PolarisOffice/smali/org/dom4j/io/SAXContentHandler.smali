...
.method protected addAttributes(Lorg/dom4j/Element;Lorg/xml/sax/Attributes;)V
    ...
    .line 913
    .local v7, noNamespaceAttributes:Z
    instance-of v10, p1, Lorg/dom4j/tree/AbstractElement;
    ...
    .line 916
    .local v5, baseElement:Lorg/dom4j/tree/AbstractElement;
    iget-object v10, p0, Lorg/dom4j/io/SAXContentHandler;->namespaceStack:Lorg/dom4j/tree/NamespaceStack;

    invoke-virtual {v5, p2, v10, v7}, Lorg/dom4j/tree/AbstractElement;->setAttributes(Lorg/xml/sax/Attributes;Lorg/dom4j/tree/NamespaceStack;Z)V

    .line 936
    .end local v5           #baseElement:Lorg/dom4j/tree/AbstractElement;
    :cond_0
    return-void
    ...
    .line 922
    invoke-interface {p2, v6}, Lorg/xml/sax/Attributes;->getQName(I)Ljava/lang/String;

    move-result-object v2

    .line 924
    .local v2, attributeQName:Ljava/lang/String;
    if-nez v7, :cond_2
    ...
    .line 926
    :cond_2
    invoke-interface {p2, v6}, Lorg/xml/sax/Attributes;->getURI(I)Ljava/lang/String;

    move-result-object v3

    .line 927
    .local v3, attributeURI:Ljava/lang/String;
    ...
    invoke-virtual {v10, v3, v1, v2}, Lorg/dom4j/tree/NamespaceStack;->getAttributeQName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/dom4j/QName;

    move-result-object v8

    .line 932
    .local v8, qName:Lorg/dom4j/QName;
    invoke-interface {p1, v8, v4}, Lorg/dom4j/Element;->addAttribute(Lorg/dom4j/QName;Ljava/lang/String;)Lorg/dom4j/Element;

    .line 921
    .end local v1           #attributeLocalName:Ljava/lang/String;
    .end local v3           #attributeURI:Ljava/lang/String;
    .end local v4           #attributeValue:Ljava/lang/String;
    .end local v8           #qName:Lorg/dom4j/QName;
    :cond_3

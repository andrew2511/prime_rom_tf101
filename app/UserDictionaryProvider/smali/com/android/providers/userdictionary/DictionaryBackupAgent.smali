...
.method private getDictionary()[B
    ...
    sget-object v6, Lcom/android/providers/userdictionary/DictionaryBackupAgent;->PROJECTION:[Ljava/lang/String;
    ...
    sget-object v4, Lcom/android/providers/userdictionary/DictionaryBackupAgent;->EMPTY_DATA:[B
    ...
    .line 151
    const-string v4, "DictionaryBackupAgent"

    const-string v5, "Couldn\'t read from the cursor"
    ...
    .line 159
    .local v14, gzip:Ljava/util/zip/GZIPOutputStream;
    :goto_1
    ...
    .line 165
    .local v19, out:Ljava/lang/String;
    ...
    .end local v14           #gzip:Ljava/util/zip/GZIPOutputStream;
    .end local v16           #line:[B
    .end local v17           #locale:Ljava/lang/String;
    .end local v18           #name:Ljava/lang/String;
    .end local v19           #out:Ljava/lang/String;
    :catch_0
    move-exception v4
    ...
    const-string v6, "Couldn\'t compress the dictionary:\n"
    ...
    .restart local v14       #gzip:Ljava/util/zip/GZIPOutputStream;
    :cond_2
    :try_start_2
...
.method private restoreDictionary(Landroid/app/backup/BackupDataInput;Landroid/net/Uri;)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/providers/userdictionary/DictionaryBackupAgent;->readInt([BI)I

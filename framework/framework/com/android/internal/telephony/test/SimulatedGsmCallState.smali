...
.method public onDial(Ljava/lang/String;)Z
    ...
    .line 664
    iput-boolean v7, p0, Lcom/android/internal/telephony/test/SimulatedGsmCallState;->nextDialFailImmediately:Z

    .line 666
    const-string v4, "GSM"

    const-string v5, "SC< dial fail (per request)"
    ...
    const-string v5, "SC< dial fail (invalid ph num)"
    ...
    const-string v5, "SC< dial ignored (gprs)"
    ...
    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_69
    .catch Lcom/android/internal/telephony/test/InvalidStateEx; {:try_start_5c .. :try_end_69} :catch_6b
...
.method public separateCall(I)Z
    ...
    :try_end_43
    .catch Lcom/android/internal/telephony/test/InvalidStateEx; {:try_start_2 .. :try_end_43} :catch_48

...
.method private constructor <init>([Ljava/util/Map$Entry;Ljava/util/Comparator;II)V
    ...
    .line 384
    .local v1, tmp:[Ljava/util/Map$Entry;,"[Ljava/util/Map$Entry<TK;TV;>;"
    iput-object v1, p0, Lcom/google/common/collect/ImmutableSortedMap;->entries:[Ljava/util/Map$Entry;
...
.method private static copyOfInternal(Ljava/util/Map;Ljava/util/Comparator;)Lcom/google/common/collect/ImmutableSortedMap;
    ...
    .line 215
    .local v8, sortedMap:Ljava/util/SortedMap;,"Ljava/util/SortedMap<**>;"
    invoke-interface {v8}, Ljava/util/SortedMap;->comparator()Ljava/util/Comparator;
    ...
    .end local v8           #sortedMap:Ljava/util/SortedMap;,"Ljava/util/SortedMap<**>;"
    :cond_0
    :goto_0
    if-eqz v7, :cond_3
    ...
    .local v5, kvMap:Lcom/google/common/collect/ImmutableSortedMap;,"Lcom/google/common/collect/ImmutableSortedMap<TK;TV;>;"
    move-object v9, v5

    .line 241
    .end local v5           #kvMap:Lcom/google/common/collect/ImmutableSortedMap;,"Lcom/google/common/collect/ImmutableSortedMap<TK;TV;>;"
    :goto_1
    return-object v9

    .line 216
    .restart local v1       #comparator2:Ljava/util/Comparator;,"Ljava/util/Comparator<*>;"
    .restart local v8       #sortedMap:Ljava/util/SortedMap;,"Ljava/util/SortedMap<**>;"
    :cond_1
    const/4 v9, 0x0
    ...
    .line 231
    .local v6, list:Ljava/util/List;,"Ljava/util/List<Ljava/util/Map$Entry<**>;>;"
    ...
    invoke-static {v9, v10}, Lcom/google/common/collect/ImmutableSortedMap;->entryOf(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    .line 236
    .local v3, entryArray:[Ljava/util/Map$Entry;,"[Ljava/util/Map$Entry<**>;"
    if-nez v7, :cond_5

    .line 237
    invoke-static {v3, p1}, Lcom/google/common/collect/ImmutableSortedMap;->sortEntries([Ljava/util/Map$Entry;Ljava/util/Comparator;)V

    .line 238
    invoke-static {v3, p1}, Lcom/google/common/collect/ImmutableSortedMap;->validateEntries([Ljava/util/Map$Entry;Ljava/util/Comparator;)V

    .line 241
    :cond_5
    new-instance v9, Lcom/google/common/collect/ImmutableSortedMap;

    invoke-direct {v9, v3, p1}, Lcom/google/common/collect/ImmutableSortedMap;-><init>([Ljava/util/Map$Entry;Ljava/util/Comparator;)V
...
.method public entrySet()Lcom/google/common/collect/ImmutableSet;
    ...
    iput-object v1, p0, Lcom/google/common/collect/ImmutableSortedMap;->entrySet:Lcom/google/common/collect/ImmutableSet;
...
.method public keySet()Lcom/google/common/collect/ImmutableSortedSet;
    ...
    iput-object v1, p0, Lcom/google/common/collect/ImmutableSortedMap;->keySet:Lcom/google/common/collect/ImmutableSortedSet;
...
.method public values()Lcom/google/common/collect/ImmutableCollection;
    ...
    new-instance v1, Lcom/google/common/collect/ImmutableSortedMap$Values;

    invoke-direct {v1, p0}, Lcom/google/common/collect/ImmutableSortedMap$Values;-><init>(Lcom/google/common/collect/ImmutableSortedMap;)V

    iput-object v1, p0, Lcom/google/common/collect/ImmutableSortedMap;->values:Lcom/google/common/collect/ImmutableCollection;

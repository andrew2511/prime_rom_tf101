...
.method public static load(I)Landroid/view/KeyCharacterMap;
    ...
    .prologue
    .line 178
    sget-object v2, Landroid/view/KeyCharacterMap;->sInstances:Landroid/util/SparseArray;

    monitor-enter v2

    .line 179
    :try_start_3
    sget-object v3, Landroid/view/KeyCharacterMap;->sInstances:Landroid/util/SparseArray;
    ...
    .line 180
    .local v0, map:Landroid/view/KeyCharacterMap;
    if-nez v0, :cond_1b

    .line 181
    invoke-static {p0}, Landroid/view/KeyCharacterMap;->nativeLoad(I)I
    ...
    .end local v0           #map:Landroid/view/KeyCharacterMap;
    invoke-direct {v0, p0, v1}, Landroid/view/KeyCharacterMap;-><init>(II)V

    .line 183
    .restart local v0       #map:Landroid/view/KeyCharacterMap;
    sget-object v3, Landroid/view/KeyCharacterMap;->sInstances:Landroid/util/SparseArray;
...
.method private static native nativeLoad(I)I
.end method
...
.method public getKeyData(ILandroid/view/KeyCharacterMap$KeyData;)Z
    ...
    invoke-static {v1, p1}, Landroid/view/KeyCharacterMap;->nativeGetNumber(II)C
    ...
    invoke-static {v2, p1, v3}, Landroid/view/KeyCharacterMap;->nativeGetCharacter(III)C
    ...
    invoke-static {v2, p1, v4}, Landroid/view/KeyCharacterMap;->nativeGetCharacter(III)C
    ...
    invoke-static {v2, p1, v5}, Landroid/view/KeyCharacterMap;->nativeGetCharacter(III)C
    ...
    invoke-static {v2, p1, v6}, Landroid/view/KeyCharacterMap;->nativeGetCharacter(III)C

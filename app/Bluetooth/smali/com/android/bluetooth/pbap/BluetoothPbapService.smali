...
.method private declared-synchronized setState(II)V
    ...
    const-string v2, "android.bluetooth.pbap.intent.PBAP_PREVIOUS_STATE"
    ...
    .line 625
    const-string v2, "android.bluetooth.pbap.intent.PBAP_STATE"
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/bluetooth/pbap/BluetoothPbapService;->sendBroadcast(Landroid/content/Intent;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 629
    :try_start_1
    iget-object v2, p0, Lcom/android/bluetooth/pbap/BluetoothPbapService;->mBluetoothService:Landroid/bluetooth/IBluetooth;

    iget-object v3, p0, Lcom/android/bluetooth/pbap/BluetoothPbapService;->mRemoteDevice:Landroid/bluetooth/BluetoothDevice;

    iget v4, p0, Lcom/android/bluetooth/pbap/BluetoothPbapService;->mState:I

    invoke-interface {v2, v3, v4, p1}, Landroid/bluetooth/IBluetooth;->sendConnectionStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v3, "RemoteException in sendConnectionStateChange"

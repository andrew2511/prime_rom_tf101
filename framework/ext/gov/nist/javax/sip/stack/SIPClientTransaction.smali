...
.method private final createErrorAck()Ljavax/sip/message/Request;
    ...
    .end local p0
    check-cast p0, Lgov/nist/javax/sip/header/To;

    invoke-virtual {v0, p0}, Lgov/nist/javax/sip/message/SIPRequest;->createErrorAck(Lgov/nist/javax/sip/header/To;)Lgov/nist/javax/sip/message/SIPRequest;
...
.method private inviteClientTransaction(Lgov/nist/javax/sip/message/SIPResponse;Lgov/nist/javax/sip/stack/MessageChannel;Lgov/nist/javax/sip/stack/SIPDialog;)V
    ...
    :try_end_78
    .catch Ljavax/sip/SipException; {:try_start_62 .. :try_end_78} :catch_1bc
    ...
    :try_end_cb
    .catch Ljava/lang/Exception; {:try_start_c2 .. :try_end_cb} :catch_101
    ...
    invoke-virtual {p0, v3}, Lgov/nist/javax/sip/stack/SIPClientTransaction;->sendMessage(Lgov/nist/javax/sip/message/SIPMessage;)V
    :try_end_15c
    .catch Ljava/lang/Exception; {:try_start_153 .. :try_end_15c} :catch_186
    ...
    invoke-virtual {p0, v3}, Lgov/nist/javax/sip/stack/SIPClientTransaction;->sendMessage(Lgov/nist/javax/sip/message/SIPMessage;)V
    :try_end_1ac
    .catchall {:try_start_1a3 .. :try_end_1ac} :catchall_1b7
    .catch Ljava/lang/Exception; {:try_start_1a3 .. :try_end_1ac} :catch_1b1
...
.method public createAck()Ljavax/sip/message/Request;
    ...
    .end local p0
    check-cast p0, Lgov/nist/javax/sip/header/Route;

    invoke-virtual {p0}, Lgov/nist/javax/sip/header/Route;->getAddress()Ljavax/sip/address/Address;
    ...
    invoke-interface {p0}, Ljavax/sip/address/SipURI;->hasLrParam()Z
    ...
    invoke-virtual {v6, p0}, Lgov/nist/javax/sip/header/Route;->setAddress(Ljavax/sip/address/Address;)V
...
.method protected fireRetransmissionTimer()V
    ...
    :try_end_40
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_40} :catch_91
    ...
    :try_end_44
    .catch Ljavax/sip/InvalidArgumentException; {:try_start_41 .. :try_end_44} :catch_9c
    .catch Ljava/io/IOException; {:try_start_41 .. :try_end_44} :catch_91
    ...
    :try_end_8f
    .catch Ljava/io/IOException; {:try_start_44 .. :try_end_8f} :catch_91
    ...
    invoke-static {v1}, Lgov/nist/core/InternalErrorHandler;->handleException(Ljava/lang/Exception;)V
    :try_end_a0
    .catch Ljava/io/IOException; {:try_start_9d .. :try_end_a0} :catch_91
...
.method public processResponse(Lgov/nist/javax/sip/message/SIPResponse;Lgov/nist/javax/sip/stack/MessageChannel;)V
    ...
    monitor-exit p0
    :try_end_92
    .catchall {:try_start_4b .. :try_end_92} :catchall_c3
    ...
    invoke-virtual {p0, v2, v7}, Lgov/nist/javax/sip/stack/SIPClientTransaction;->setDialog(Lgov/nist/javax/sip/stack/SIPDialog;Ljava/lang/String;)V
    :try_end_e1
    .catchall {:try_start_c6 .. :try_end_e1} :catchall_c3
...
.method public declared-synchronized processResponse(Lgov/nist/javax/sip/message/SIPResponse;Lgov/nist/javax/sip/stack/MessageChannel;Lgov/nist/javax/sip/stack/SIPDialog;)V
    ...
    invoke-virtual {p0}, Lgov/nist/javax/sip/stack/SIPClientTransaction;->getState()Ljavax/sip/TransactionState;
    :try_end_4
    .catchall {:try_start_1 .. :try_end_4} :catchall_9e
    ...
    :try_end_76
    .catchall {:try_start_9 .. :try_end_76} :catchall_9e
    ...
    :try_end_7f
    .catchall {:try_start_76 .. :try_end_7f} :catchall_9e
    ...
    .catch Ljava/io/IOException; {:try_start_a1 .. :try_end_a4} :catch_80
...
.method public sendMessage(Lgov/nist/javax/sip/message/SIPMessage;)V
    ...
    :try_end_f
    .catchall {:try_start_1 .. :try_end_f} :catchall_90
    ...
    :try_end_16
    .catchall {:try_start_f .. :try_end_16} :catchall_90
    .catch Ljava/text/ParseException; {:try_start_f .. :try_end_16} :catch_f3
    ...
    :try_end_84
    .catchall {:try_start_16 .. :try_end_84} :catchall_90
    ...
    invoke-super {p0, v3}, Lgov/nist/javax/sip/stack/SIPTransaction;->sendMessage(Lgov/nist/javax/sip/message/SIPMessage;)V
    :try_end_ca
    .catchall {:try_start_97 .. :try_end_ca} :catchall_90
    .catch Ljava/io/IOException; {:try_start_97 .. :try_end_ca} :catch_df
    ...
    invoke-virtual {p0, v4}, Lgov/nist/javax/sip/stack/SIPClientTransaction;->setState(Ljavax/sip/TransactionState;)V
    :try_end_de
    .catchall {:try_start_cd .. :try_end_de} :catchall_90
    ...
    throw v1
    :try_end_e7
    .catchall {:try_start_e1 .. :try_end_e7} :catchall_90
    ...
    invoke-virtual {p0, v4}, Lgov/nist/javax/sip/stack/SIPClientTransaction;->enableTimeoutTimer(I)V
    :try_end_f2
    .catchall {:try_start_e7 .. :try_end_f2} :catchall_90
    .catch Ljava/io/IOException; {:try_start_e7 .. :try_end_f2} :catch_df
...
.method public sendRequest()V
    ...
    :try_end_39
    .catch Ljava/text/ParseException; {:try_start_36 .. :try_end_39} :catch_9e
    ...
    throw v4
    :try_end_8f
    .catch Ljava/io/IOException; {:try_start_60 .. :try_end_8f} :catch_8f
    ...
    invoke-virtual {p0, v3}, Lgov/nist/javax/sip/stack/SIPClientTransaction;->sendMessage(Lgov/nist/javax/sip/message/SIPMessage;)V
    :try_end_14d
    .catch Ljava/io/IOException; {:try_start_bc .. :try_end_14d} :catch_8f

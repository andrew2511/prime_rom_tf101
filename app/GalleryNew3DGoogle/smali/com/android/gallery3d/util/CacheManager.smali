...
.field private static sCacheMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Ljava/lang/String;",
            "Lcom/android/gallery3d/util/BlobCache;",
            ">;"
        }
    .end annotation
.end field
...
.method public static getCache(Landroid/content/Context;Ljava/lang/String;III)Lcom/android/gallery3d/util/BlobCache;
    .locals 10
    .parameter "context"
    .parameter "filename"
    ...
    check-cast v6, Lcom/android/gallery3d/util/BlobCache;

    .line 45
    .local v6, cache:Lcom/android/gallery3d/util/BlobCache;
    if-nez v6, :cond_1
    ...
    :try_start_1
    new-instance v0, Lcom/android/gallery3d/util/BlobCache;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/gallery3d/util/BlobCache;-><init>(Ljava/lang/String;IIZI)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    .line 51
    .end local v6           #cache:Lcom/android/gallery3d/util/BlobCache;
    .local v0, cache:Lcom/android/gallery3d/util/BlobCache;
    :try_start_2
    sget-object v2, Lcom/android/gallery3d/util/CacheManager;->sCacheMap:Ljava/util/HashMap;
    ...
    .line 52
    .end local v0           #cache:Lcom/android/gallery3d/util/BlobCache;
    .restart local v1       #path:Ljava/lang/String;
    .restart local v6       #cache:Lcom/android/gallery3d/util/BlobCache;
    ...
    .line 53
    .end local v6           #cache:Lcom/android/gallery3d/util/BlobCache;
    .restart local v0       #cache:Lcom/android/gallery3d/util/BlobCache;
...
.method private static removeOldFilesIfNecessary(Landroid/content/Context;)V
    ...
    invoke-static {v4}, Lcom/android/gallery3d/util/BlobCache;->deleteFiles(Ljava/lang/String;)V

...
.method public static createFromResource(Landroid/renderscript/RenderScript;Landroid/content/res/Resources;I)Landroid/renderscript/FileA3D;
    ...
    .line 283
    .local v4, fileId:I
    instance-of v6, v5, Landroid/content/res/AssetManager$AssetInputStream;
    ...
    invoke-virtual {v6}, Landroid/content/res/AssetManager$AssetInputStream;->getAssetInt()I

    move-result v1

    .line 285
    .local v1, asset:I
    invoke-virtual {p0, v1}, Landroid/renderscript/RenderScript;->nFileA3DCreateFromAssetStream(I)I
    ...
    const-string v8, "Unable to create a3d file from resource "
    ...
    .line 278
    .end local v1           #asset:I
    .end local v4           #fileId:I
    :catch_34
    move-exception v2
    ...
    const-string v8, "Unable to open resource "
    ...
    .restart local v4       #fileId:I
    :cond_4e
    new-instance v6, Landroid/renderscript/RSRuntimeException;

    const-string v7, "Unsupported asset stream"
    ...
    .line 293
    .restart local v1       #asset:I
    :cond_56
    new-instance v3, Landroid/renderscript/FileA3D;

    invoke-direct {v3, v4, p0, v5}, Landroid/renderscript/FileA3D;-><init>(ILandroid/renderscript/RenderScript;Ljava/io/InputStream;)V

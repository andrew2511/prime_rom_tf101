...
.field public static final DEFAULT_WHITELIST:Lcom/google/android/common/html/parser/HtmlWhitelist; = null
...
.method public constructor <init>(Lcom/google/android/common/html/parser/HtmlParser$ParseStyle;)V
    ...
    .line 57
    new-array v0, v3, [Lcom/google/android/common/html/parser/HtmlWhitelist;

    sget-object v1, Lcom/google/android/common/html/parser/HtmlParser;->DEFAULT_WHITELIST:Lcom/google/android/common/html/parser/HtmlWhitelist;
    ...
    :goto_1
    iput-boolean v0, p0, Lcom/google/android/common/html/parser/HtmlParser;->preserveValidHtml:Z
...
.method private addEndTag(Lcom/google/android/common/html/parser/HTML$Element;III)V
    ...
    invoke-virtual {v4, v5, p3}, Ljava/lang/String;->substring(II)Ljava/lang/String;
...
.method public static main([Ljava/lang/String;)V
    ...
    sput-boolean v3, Lcom/google/android/common/html/parser/HtmlParser;->DEBUG:Z
    ...
    invoke-virtual {v2, v1}, Lcom/google/android/common/html/parser/HtmlParser;->parse(Ljava/lang/String;)Lcom/google/android/common/html/parser/HtmlDocument;
    ...
    invoke-virtual {v0}, Lcom/google/android/common/html/parser/HtmlDocument;->toString()Ljava/lang/String;
...
.method private scanComment(II)I
    ...
    invoke-virtual {v1, p1, v4, v2, v3}, Ljava/lang/String;->regionMatches(ILjava/lang/String;II)Z
...
# virtual methods
.method public addWhitelist(Lcom/google/android/common/html/parser/HtmlWhitelist;)V
    .locals 1
    .parameter "whitelist"

    .prologue
    .line 149
    iget-object v0, p0, Lcom/google/android/common/html/parser/HtmlParser;->whitelists:Ljava/util/List;
...
.method public isClipped()Z
    ...
    .prologue
    .line 117
    iget-boolean v0, p0, Lcom/google/android/common/html/parser/HtmlParser;->clipped:Z
...
.method lookupAttribute(Ljava/lang/String;)Lcom/google/android/common/html/parser/HTML$Attribute;
    ...
    check-cast p0, Lcom/google/android/common/html/parser/HtmlWhitelist;

    invoke-interface {p0, p1}, Lcom/google/android/common/html/parser/HtmlWhitelist;->lookupAttribute(Ljava/lang/String;)Lcom/google/android/common/html/parser/HTML$Attribute;
...
.method lookupElement(Ljava/lang/String;)Lcom/google/android/common/html/parser/HTML$Element;
    ...
    invoke-interface {p0, p1}, Lcom/google/android/common/html/parser/HtmlWhitelist;->lookupElement(Ljava/lang/String;)Lcom/google/android/common/html/parser/HTML$Element;
...
.method public parse(Ljava/lang/String;)Lcom/google/android/common/html/parser/HtmlDocument;
    ...
    .line 181
    iput-boolean v7, p0, Lcom/google/android/common/html/parser/HtmlParser;->clipped:Z
    ...
    iget-object v6, p0, Lcom/google/android/common/html/parser/HtmlParser;->state:Lcom/google/android/common/html/parser/HtmlParser$State;

    invoke-virtual {v6}, Lcom/google/android/common/html/parser/HtmlParser$State;->ordinal()I
    ...
    sget-object v6, Lcom/google/android/common/html/parser/HtmlParser$State;->IN_TEXT:Lcom/google/android/common/html/parser/HtmlParser$State;
    ...
    sget-object v6, Lcom/google/android/common/html/parser/HtmlParser$State;->IN_CDATA:Lcom/google/android/common/html/parser/HtmlParser$State;
...
.method scanTag(II)I
    ...
    iget-object v0, v0, Lcom/google/android/common/html/parser/HtmlParser;->html:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/google/android/common/html/parser/HtmlParser;->state:Lcom/google/android/common/html/parser/HtmlParser$State;

    .line 642
    const/4 v15, 0x0

    .line 643
    .local v15, isEndTag:Z
    move-object/from16 v0, p0
    ...
    .line 649
    :cond_0
    new-instance v20, Lcom/google/android/common/html/parser/HtmlParser$TagNameScanner;
    ...
    invoke-direct {v0, v1}, Lcom/google/android/common/html/parser/HtmlParser$TagNameScanner;-><init>(Ljava/lang/String;)V

    .line 650
    .local v20, tagNameScanner:Lcom/google/android/common/html/parser/HtmlParser$TagNameScanner;
    move-object/from16 v0, v20
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/android/common/html/parser/HtmlParser$TagNameScanner;->scanName(II)I

    move-result v10

    .line 651
    .local v10, pos:I
    invoke-virtual/range {v20 .. v20}, Lcom/google/android/common/html/parser/HtmlParser$TagNameScanner;->getTagName()Ljava/lang/String;
    ...
    .line 653
    .local v6, element:Lcom/google/android/common/html/parser/HTML$Element;
    if-nez v19, :cond_7
    ...
    iget-boolean v0, v0, Lcom/google/android/common/html/parser/HtmlParser;->preserveAll:Z
    ...
    :goto_1
    invoke-static {v5, v7}, Lcom/google/android/common/html/parser/HtmlDocument;->createText(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/common/html/parser/HtmlDocument$Text;

    move-result-object v21

    .line 660
    .local v21, text:Lcom/google/android/common/html/parser/HtmlDocument$Text;
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/google/android/common/html/parser/HtmlParser;->nodes:Ljava/util/List;
    ...
    .line 780
    .end local v21           #text:Lcom/google/android/common/html/parser/HtmlDocument$Text;
    :goto_2
    return v5

    .line 631
    .end local v6           #element:Lcom/google/android/common/html/parser/HTML$Element;
    .end local v10           #pos:I
    .end local v15           #isEndTag:Z
    .end local v16           #nameStart:I
    .end local v19           #tagName:Ljava/lang/String;
    .end local v20           #tagNameScanner:Lcom/google/android/common/html/parser/HtmlParser$TagNameScanner;
    :cond_1
    const/4 v5, 0x0
    ...
    .line 659
    .restart local v6       #element:Lcom/google/android/common/html/parser/HTML$Element;
    .restart local v10       #pos:I
    .restart local v15       #isEndTag:Z
    .restart local v16       #nameStart:I
    .restart local v19       #tagName:Ljava/lang/String;
    .restart local v20       #tagNameScanner:Lcom/google/android/common/html/parser/HtmlParser$TagNameScanner;
    :cond_2
    const/4 v7, 0x0
    ...
    .line 683
    .local v11, isSingleTag:Z
    const/4 v12, 0x0

    .line 684
    .local v12, attributes:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/google/android/common/html/parser/HtmlDocument$TagAttribute;>;"
    move v8, v10

    .line 685
    .local v8, allAttributesStartPos:I
    move v9, v10

    .line 686
    .local v9, nextAttributeStartPos:I
    new-instance v13, Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;
    ...
    invoke-direct {v13, v5}, Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;-><init>(Ljava/lang/String;)V

    .line 687
    .local v13, attributeScanner:Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;
    :goto_4
    move v0, v10
    ...
    .line 745
    .local v22, textNodeContent:Ljava/lang/String;
    const/16 v17, 0x0

    .line 746
    .local v17, originalContent:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 754
    .end local v8           #allAttributesStartPos:I
    :cond_6
    :goto_6
    move-object/from16 v0, p0
    ...
    invoke-static {v0, v1}, Lcom/google/android/common/html/parser/HtmlDocument;->createEscapedText(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/common/html/parser/HtmlDocument$Text;
    ...
    .line 669
    .end local v9           #nextAttributeStartPos:I
    .end local v11           #isSingleTag:Z
    .end local v12           #attributes:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/google/android/common/html/parser/HtmlDocument$TagAttribute;>;"
    .end local v13           #attributeScanner:Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;
    .end local v17           #originalContent:Ljava/lang/String;
    .end local v22           #textNodeContent:Ljava/lang/String;
    :cond_7
    move-object/from16 v0, p0
    ...
    .line 671
    sget-boolean v5, Lcom/google/android/common/html/parser/HtmlParser;->DEBUG:Z
    ...
    invoke-static {v5}, Lcom/google/android/common/html/parser/HtmlParser;->debug(Ljava/lang/String;)V
    ...
    .line 697
    .restart local v8       #allAttributesStartPos:I
    .restart local v9       #nextAttributeStartPos:I
    .restart local v11       #isSingleTag:Z
    .restart local v12       #attributes:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/google/android/common/html/parser/HtmlDocument$TagAttribute;>;"
    .restart local v13       #attributeScanner:Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/google/android/common/html/parser/HtmlParser;->addEndTag(Lcom/google/android/common/html/parser/HTML$Element;III)V
    ...
    .line 718
    :cond_d
    invoke-virtual {v13}, Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;->reset()V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;->scanName(II)I
    ...
    .line 723
    invoke-virtual {v13}, Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;->getName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;->scanValue(II)I
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/google/android/common/html/parser/HtmlParser;->addAttribute(Ljava/util/ArrayList;Lcom/google/android/common/html/parser/HtmlParser$AttributeScanner;II)V
    ...
    .line 748
    .restart local v17       #originalContent:Ljava/lang/String;
    .restart local v22       #textNodeContent:Ljava/lang/String;
    :cond_13
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/google/android/common/html/parser/HtmlParser;->preserveValidHtml:Z
    ...
    invoke-static {v5}, Lcom/google/android/common/base/CharMatcher;->is(C)Lcom/google/android/common/base/CharMatcher;
    ...
    .end local v8           #allAttributesStartPos:I
    invoke-virtual {v5, v7, v8}, Lcom/google/android/common/base/CharMatcher;->replaceFrom(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    .line 770
    :cond_17
    sget-object v5, Lcom/google/android/common/html/parser/HTML4;->SCRIPT_ELEMENT:Lcom/google/android/common/html/parser/HTML$Element;

    invoke-virtual {v5, v6}, Lcom/google/android/common/html/parser/HTML$Element;->equals(Ljava/lang/Object;)Z

    move-result v5

    if-nez v5, :cond_18

    sget-object v5, Lcom/google/android/common/html/parser/HTML4;->STYLE_ELEMENT:Lcom/google/android/common/html/parser/HTML$Element;
    ...
    .line 771
    :cond_18
    sget-object v5, Lcom/google/android/common/html/parser/HtmlParser$State;->IN_CDATA:Lcom/google/android/common/html/parser/HtmlParser$State;
    ...
    .line 774
    invoke-direct/range {v5 .. v12}, Lcom/google/android/common/html/parser/HtmlParser;->addStartTag(Lcom/google/android/common/html/parser/HTML$Element;IIIIZLjava/util/ArrayList;)V
...
.method public setClipLength(I)V
    ...
    .line 113
    :cond_0
    iput p1, p0, Lcom/google/android/common/html/parser/HtmlParser;->clipLength:I

    .line 114
    return-void
.end method

.method public setWhitelist(Lcom/google/android/common/html/parser/HtmlWhitelist;)V
    .locals 2
    .parameter "whitelist"
    ...
    new-array v0, v0, [Lcom/google/android/common/html/parser/HtmlWhitelist;

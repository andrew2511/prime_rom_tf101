...
.method constructor <init>(Lorg/apache/commons/logging/Log;Lorg/apache/http/protocol/HttpRequestExecutor;Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/ConnectionReuseStrategy;Lorg/apache/http/conn/ConnectionKeepAliveStrategy;Lorg/apache/http/conn/routing/HttpRoutePlanner;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/client/HttpRequestRetryHandler;Lorg/apache/http/client/RedirectHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/UserTokenHandler;Lorg/apache/http/params/HttpParams;)V
    ...
    const-string v3, "Log may not be null."
    ...
    const-string v3, "Request executor may not be null."
    ...
    const-string v3, "Client connection manager may not be null."
    ...
    const-string v3, "Connection reuse strategy may not be null."
    ...
    const-string v3, "Connection keep alive strategy may not be null."
    ...
    const-string v3, "Route planner may not be null."
    ...
    const-string v3, "HTTP protocol processor may not be null."
    ...
    const-string v3, "HTTP request retry handler may not be null."
    ...
    const-string v3, "Redirect handler may not be null."
    ...
    const-string v3, "Target authentication handler may not be null."
    ...
    const-string v3, "Proxy authentication handler may not be null."
    ...
    const-string v3, "User token handler may not be null."
    ...
    iput-object v0, v1, Lorg/apache/http/impl/client/DefaultRequestDirector;->proxyAuthHandler:Lorg/apache/http/client/AuthenticationHandler;
    ...
    iput-object v0, v1, Lorg/apache/http/impl/client/DefaultRequestDirector;->userTokenHandler:Lorg/apache/http/client/UserTokenHandler;
    ...
    iput-object v0, v1, Lorg/apache/http/impl/client/DefaultRequestDirector;->params:Lorg/apache/http/params/HttpParams;
    ...
    invoke-interface {v2, v3, v4}, Lorg/apache/http/params/HttpParams;->getIntParameter(Ljava/lang/String;I)I

    move-result v2

    iput v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->maxRedirects:I
    ...
    iput-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->targetAuthState:Lorg/apache/http/auth/AuthState;
    ...
    iput-object v2, p0, Lorg/apache/http/impl/client/DefaultRequestDirector;->proxyAuthState:Lorg/apache/http/auth/AuthState;
...
.method protected createTunnelToTarget(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)Z
    ...
    invoke-interface {v10, v4}, Lorg/apache/http/HttpRequest;->setParams(Lorg/apache/http/params/HttpParams;)V
    ...
    invoke-interface {v8, v4}, Lorg/apache/http/HttpResponse;->setParams(Lorg/apache/http/params/HttpParams;)V
    ...
    .line 807
    .local v14, ex:Lorg/apache/http/auth/AuthenticationException;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v14}, Lorg/apache/http/auth/AuthenticationException;->getMessage()Ljava/lang/String;
    ...
    .line 838
    .end local v10           #connect:Lorg/apache/http/HttpRequest;
    .end local v11           #credsProvider:Lorg/apache/http/client/CredentialsProvider;
    .end local v14           #ex:Lorg/apache/http/auth/AuthenticationException;
    ...
    invoke-direct {v4, v13}, Lorg/apache/http/entity/BufferedHttpEntity;-><init>(Lorg/apache/http/HttpEntity;)V
    ...
    .end local v13           #entity:Lorg/apache/http/HttpEntity;
    .restart local v5       #challenges:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;Lorg/apache/http/Header;>;"
    .restart local v10       #connect:Lorg/apache/http/HttpRequest;
    .restart local v11       #credsProvider:Lorg/apache/http/client/CredentialsProvider;
    :cond_6
    move-object/from16 v0, p0
...
.method protected handleResponse(Lorg/apache/http/impl/client/RoutedRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/impl/client/RoutedRequest;
    ...
    .line 959
    .local v21, route:Lorg/apache/http/conn/routing/HttpRoute;
    ...
    invoke-virtual/range {v23 .. v23}, Ljava/net/URI;->getPort()I
    ...
    .line 982
    .local v15, newTarget:Lorg/apache/http/HttpHost;
    move-object/from16 v0, p0
    ...
    .line 986
    invoke-virtual/range {v21 .. v21}, Lorg/apache/http/conn/routing/HttpRoute;->getTargetHost()Lorg/apache/http/HttpHost;

    move-result-object v4

    invoke-virtual {v4, v15}, Lorg/apache/http/HttpHost;->equals(Ljava/lang/Object;)Z
    ...
    .line 989
    .local v10, authScheme:Lorg/apache/http/auth/AuthScheme;
    if-eqz v10, :cond_1

    invoke-interface {v10}, Lorg/apache/http/auth/AuthScheme;->isConnectionBased()Z
    ...
    .line 994
    .end local v10           #authScheme:Lorg/apache/http/auth/AuthScheme;
    :cond_1
    new-instance v19, Lorg/apache/http/impl/client/HttpRedirect;

    invoke-virtual/range {v20 .. v20}, Lorg/apache/http/impl/client/RequestWrapper;->getMethod()Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lorg/apache/http/impl/client/HttpRedirect;-><init>(Ljava/lang/String;Ljava/net/URI;)V

    .line 995
    .local v19, redirect:Lorg/apache/http/impl/client/HttpRedirect;
    invoke-virtual/range {v20 .. v20}, Lorg/apache/http/impl/client/RequestWrapper;->getOriginal()Lorg/apache/http/HttpRequest;

    move-result-object v16

    .line 996
    .local v16, orig:Lorg/apache/http/HttpRequest;
    invoke-interface/range {v16 .. v16}, Lorg/apache/http/HttpRequest;->getAllHeaders()[Lorg/apache/http/Header;
    ...
    invoke-virtual {v0, v1}, Lorg/apache/http/impl/client/HttpRedirect;->setHeaders([Lorg/apache/http/Header;)V

    .line 998
    new-instance v24, Lorg/apache/http/impl/client/RequestWrapper;
    ...
    .line 999
    .local v24, wrapper:Lorg/apache/http/impl/client/RequestWrapper;
    move-object/from16 v0, v24
    ...
    .line 1002
    .local v14, newRoute:Lorg/apache/http/conn/routing/HttpRoute;
    ...
    .end local v14           #newRoute:Lorg/apache/http/conn/routing/HttpRoute;
    .end local v15           #newTarget:Lorg/apache/http/HttpHost;
    .end local v16           #orig:Lorg/apache/http/HttpRequest;
    .end local v19           #redirect:Lorg/apache/http/impl/client/HttpRedirect;
    .end local v23           #uri:Ljava/net/URI;
    .end local v24           #wrapper:Lorg/apache/http/impl/client/RequestWrapper;
    :goto_0
    return-object v4
    ...
    .line 1052
    invoke-virtual/range {v21 .. v21}, Lorg/apache/http/conn/routing/HttpRoute;->getProxyHost()Lorg/apache/http/HttpHost;
    ...
    .line 1062
    .restart local v12       #ex:Lorg/apache/http/auth/AuthenticationException;
    move-object/from16 v0, p0

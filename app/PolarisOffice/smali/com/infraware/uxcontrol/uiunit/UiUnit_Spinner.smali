.class public Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;
...
# instance fields
.field private m_nIndex:I

.field private m_oContentView:Landroid/view/View;

.field private m_oControl:Lcom/infraware/uxcontrol/uiunit/UiUnitView;

.field private m_oDialog:Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;

.field private m_oPrompt:Ljava/lang/CharSequence;

.field private m_oUserValueDialog:Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;

.field protected m_strDefaultValue:Ljava/lang/CharSequence;
...
.method static synthetic $SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    .prologue
    .line 21
    sget-object v0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
    ...
    :goto_d0
    sput-object v0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
...
.method static synthetic $SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitStyle()[I
    ...
    .prologue
    .line 21
    sget-object v0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitStyle:[I
    ...
    :goto_1c
    sput-object v0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitStyle:[I
...
.method public constructor <init>(Landroid/app/Activity;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;ILjava/util/List;)V
    .locals 1
    ...
    .prologue
    .line 31
    .local p4, a_oItemList:Ljava/util/List;,"Ljava/util/List<*>;"
    invoke-direct {p0, p1, p3}, Lcom/infraware/uxcontrol/uiunit/UiUnitView;-><init>(Landroid/app/Activity;I)V

    .line 25
    const/4 v0, -0x1

    iput v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_nIndex:I

    .line 33
    iput-object p2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_eUnitStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    .line 34
    invoke-direct {p0, p3, p4}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->createUnitView(ILjava/util/List;)V

    .line 35
    return-void
.end method

.method public constructor <init>(Landroid/app/Activity;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter;)V
    .locals 1
    ...
    .prologue
    .line 38
    .local p3, a_oAdapter:Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter;,"Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter<*>;"
    ...
    invoke-virtual {p0, v0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->createNativeView(I)V

    .line 41
    iput-object p2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_eUnitStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    .line 42
    invoke-direct {p0, p3}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->createUnitView(Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter;)V

    .line 43
    return-void
.end method

.method static synthetic access$1(Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;)Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;
    .locals 1
    .parameter

    .prologue
    .line 22
    iget-object v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oDialog:Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;

    return-object v0
.end method

.method private createUnitView(ILjava/util/List;)V
    .locals 4
    .parameter "a_nItemLayoutId"
    ...
    .prologue
    .line 63
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_eUnitStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    ...
    .line 66
    :cond_0
    invoke-static {}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitStyle()[I

    move-result-object v1

    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_eUnitStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    invoke-virtual {v2}, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->ordinal()I
    ...
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oActivity:Landroid/app/Activity;
    ...
    iput-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oDialog:Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;

    .line 84
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oDialog:Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;

    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oControl:Lcom/infraware/uxcontrol/uiunit/UiUnitView;

    invoke-virtual {v2}, Lcom/infraware/uxcontrol/uiunit/UiUnitView;->getNativeView()Landroid/view/View;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;->setNativeView(Landroid/view/View;)V
    ...
    .line 87
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oControl:Lcom/infraware/uxcontrol/uiunit/UiUnitView;

    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oDialog:Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;

    invoke-virtual {v1, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnitView;->registerCommandListener(Lcom/infraware/uxcontrol/uiunit/UiUnitView$OnCommandListener;)V

    .line 89
    new-instance v1, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;

    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oActivity:Landroid/app/Activity;

    invoke-direct {v1, v2}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;-><init>(Landroid/app/Activity;)V

    iput-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oUserValueDialog:Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;

    .line 90
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oUserValueDialog:Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;

    invoke-virtual {v1, p0}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->registerCommandListener(Lcom/infraware/uxcontrol/uiunit/UiUnitView$OnCommandListener;)V

    goto :goto_0

    .line 68
    .end local v0           #oBuilder:Lcom/infraware/uxcontrol/uiunit/UiUnitBuilder;
    :pswitch_0
    new-instance v1, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;

    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oActivity:Landroid/app/Activity;

    invoke-direct {v1, v2, p1, p2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;-><init>(Landroid/app/Activity;ILjava/util/List;)V

    iput-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oControl:Lcom/infraware/uxcontrol/uiunit/UiUnitView;

    .line 69
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oControl:Lcom/infraware/uxcontrol/uiunit/UiUnitView;

    check-cast v1, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;

    const/16 v2, 0x15e

    invoke-virtual {v1, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;->setMinimumWidth(I)I
    ...
    invoke-virtual {v1, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;->setDivider(I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/infraware/uxcontrol/uiunit/UiUnitView;->setEvent(Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitEvent;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;)V

    goto :goto_1

    .line 74
    :pswitch_1
    new-instance v1, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;

    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oActivity:Landroid/app/Activity;

    invoke-direct {v1, v2, p1, p2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;-><init>(Landroid/app/Activity;ILjava/util/List;)V
    ...
    check-cast v1, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;

    const/16 v2, 0x1b2

    invoke-virtual {v1, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;->setMinimumWidth(I)I
...
.method private createUnitView(Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter;)V
    .locals 5
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-virtual {p1, v1}, Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter;->setOwner(Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;)V
    ...
    invoke-virtual {v1, p1}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;->setCustomAdapter(Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter;)V
    ...
    invoke-virtual {v0, v1, v4}, Lcom/infraware/uxcontrol/uiunit/UiUnitBuilder;->createDialog(Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;I)Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;
...
.method protected createNativeView(I)V
    ...
    .line 50
    .local v1, oView:Landroid/widget/LinearLayout;
    const v2, 0x7f0c0038
    ...
    iput-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oContentView:Landroid/view/View;

    .line 52
    new-instance v2, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner$1;

    invoke-direct {v2, p0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner$1;-><init>(Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;)V

    invoke-virtual {v1, v2}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 59
    invoke-virtual {p0, v1}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->setNativeView(Landroid/view/View;)V
...
.method public getCurrentIndex()I
    ...
    .prologue
    .line 172
    iget v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_nIndex:I
...
.method public bridge synthetic getNativeView()Landroid/view/View;
    ...
    .prologue
    .line 1
    invoke-virtual {p0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->getNativeView()Landroid/widget/LinearLayout;
...
.method public getUserValue()Ljava/lang/CharSequence;
    .locals 3

    .prologue
    .line 184
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oContentView:Landroid/view/View;
    ...
    .line 185
    .local v0, oNameView:Landroid/widget/TextView;
    if-nez v0, :cond_0
...
.method public notifyDataSetChanged()V
    ...
    .restart local p0
    :pswitch_0
    iget-object p0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oControl:Lcom/infraware/uxcontrol/uiunit/UiUnitView;

    .end local p0
    check-cast p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;
    ...
    .end local p0
    check-cast p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;

    invoke-virtual {p0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;->getAdapter()Landroid/widget/ArrayAdapter;
...
.method public varargs onCommand(Lcom/infraware/uxcontrol/uiunit/UiUnitView;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;[Ljava/lang/Object;)V
    ...
    .line 262
    invoke-static {}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    :cond_0
    :goto_0
    invoke-super {p0, p0, p2, p3}, Lcom/infraware/uxcontrol/uiunit/UiUnitView;->onCommand(Lcom/infraware/uxcontrol/uiunit/UiUnitView;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;[Ljava/lang/Object;)V
    ...
    .line 265
    .local v0, nIndex:I
    invoke-virtual {p0, v0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->setCurrentIndex(I)V
    ...
    :sswitch_1
    invoke-virtual {p0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->getUserValue()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p0, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->setUserValueDefault(Ljava/lang/CharSequence;)V

    .line 269
    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oUserValueDialog:Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;

    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->show(Z)V
    ...
    invoke-virtual {p0, v1}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->setDisplayValue(Ljava/lang/String;)V
    ...
    sget-object v3, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_SpinnerListButton:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    ...
    iget-object v2, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_strDefaultValue:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->setDisplayValue(Ljava/lang/String;)V
...
.method public setCurrentIndex(I)V
    ...
    .line 154
    iget-object v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oView:Landroid/view/View;
    ...
    .line 168
    iput p1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_nIndex:I
    ...
    .line 159
    :pswitch_0
    iget-object v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oControl:Lcom/infraware/uxcontrol/uiunit/UiUnitView;
    ...
    invoke-virtual {v0, p1, v2, v2}, Landroid/widget/ArrayAdapter;->getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oContentView:Landroid/view/View;
    ...
    check-cast v0, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;

    invoke-virtual {v0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_GridControl;->getAdapter()Landroid/widget/ArrayAdapter;
...
.method public setData(Ljava/util/List;)V
    ...
    .prologue
    .line 134
    .local p1, a_oItemList:Ljava/util/List;,"Ljava/util/List<*>;"
    return-void
.end method
...
.method public setPrompt(I)V
    .locals 1
    .parameter "a_nStringId"

    .prologue
    .line 129
    iget-object v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oActivity:Landroid/app/Activity;

    invoke-virtual {v0, p1}, Landroid/app/Activity;->getText(I)Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->setPrompt(Ljava/lang/CharSequence;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 121
    iput-object p1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oPrompt:Ljava/lang/CharSequence;

    .line 122
    iget-object v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oDialog:Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;

    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oPrompt:Ljava/lang/CharSequence;

    invoke-virtual {v0, v1}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;->setTitle(Ljava/lang/CharSequence;)V

    .line 124
    iget-object v0, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oUserValueDialog:Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;
    ...
    invoke-virtual {v0, p1}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->setTitle(Ljava/lang/CharSequence;)V
...
.method public setSize(II)V
    ...
    .prologue
    .line 137
    iget-object v1, p0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Spinner;->m_oView:Landroid/view/View;
...
.method public setUserValueDefault(Ljava/lang/CharSequence;)V
    .locals 1
    .parameter "a_strValue"
    ...
    invoke-virtual {v0, p1}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->setDefault(Ljava/lang/CharSequence;)V

    goto :goto_0
.end method

.method public setUserValueEnabled(Z)V
    .locals 2
    .parameter "a_bEnable"
    ...
    instance-of v1, v1, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;
    ...
    .line 209
    .local v0, oListControl:Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;
    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;->showFooter(Z)V

    goto :goto_0
.end method

.method public setUserValueInputMax(I)V
    .locals 1
    .parameter "a_nMaxValue"
    ...
    invoke-virtual {v0, p1}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->setMax(I)V

    goto :goto_0
.end method

.method public setUserValueInputMessage(I)V
    .locals 1
    .parameter "a_nStingId"
    ...
    invoke-virtual {v0, p1}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->setMessage(I)V
...
.method public setUserValueInputMessage(Ljava/lang/CharSequence;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->setMessage(Ljava/lang/CharSequence;)V
...
.method public setUserValueInputMin(I)V
    .locals 1
    .parameter "a_nMinValue"
    ...
    invoke-virtual {v0, p1}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->setMin(I)V

    goto :goto_0
.end method

.method public setUserValueInputType(I)V
    .locals 1
    .parameter "a_nInputType"
    ...
    invoke-virtual {v0, p1}, Lcom/infraware/uxcontrol/uicontrol/UiSpinnerUserValueDialog;->setInputType(I)V

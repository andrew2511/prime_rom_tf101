...
.method public constructor <init>(Ljava/net/CookieStore;Ljava/net/CookiePolicy;)V
    ...
    new-instance v0, Ljava/net/CookieStoreImpl;

    invoke-direct {v0}, Ljava/net/CookieStoreImpl;-><init>()V

    :goto_a
    iput-object v0, p0, Ljava/net/CookieManager;->store:Ljava/net/CookieStore;
    ...
    :goto_10
    iput-object v0, p0, Ljava/net/CookieManager;->policy:Ljava/net/CookiePolicy;
...
.method private static parseCookie(Ljava/util/Map;)Ljava/util/List;
    ...
    .end local p0           #responseHeaders:Ljava/util/Map;,"Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/String;>;>;"
    :cond_d

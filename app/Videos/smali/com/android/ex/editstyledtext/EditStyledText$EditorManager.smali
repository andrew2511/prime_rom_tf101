...
.method private clearStyles(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 1078
    const-string v10, "EditStyledText"

    const-string v11, "--- onClearStyles"
    ...
    invoke-interface {v2, v10, v5, v11}, Landroid/text/Editable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object v9

    .line 1084
    .local v9, styles:[Ljava/lang/Object;
    move-object v1, v9
    ...
    .line 1085
    .local v8, style:Ljava/lang/Object;
    instance-of v10, v8, Landroid/text/style/ParagraphStyle;

    if-nez v10, :cond_0

    instance-of v10, v8, Landroid/text/style/QuoteSpan;

    if-nez v10, :cond_0

    instance-of v10, v8, Landroid/text/style/CharacterStyle;
    ...
    .line 1088
    :cond_0
    instance-of v10, v8, Landroid/text/style/ImageSpan;

    if-nez v10, :cond_1

    instance-of v10, v8, Lcom/android/ex/editstyledtext/EditStyledText$EditStyledTextSpans$HorizontalLineSpan;

    if-eqz v10, :cond_2

    .line 1089
    :cond_1
    invoke-interface {v2, v8}, Landroid/text/Editable;->getSpanStart(Ljava/lang/Object;)I
    ...
    invoke-interface {v2, v7, v3, v10}, Landroid/text/Editable;->replace(IILjava/lang/CharSequence;)Landroid/text/Editable;
    ...
    .end local v4           #i$:I
    .end local v6           #len$:I
    .end local v8           #style:Ljava/lang/Object;
    .end local v9           #styles:[Ljava/lang/Object;
    :cond_4
    return-void
.end method
...
.method private dumpSpannableString(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v5, v8, v3, v9}, Landroid/text/Spannable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    invoke-interface {v5, v6}, Landroid/text/Spannable;->getSpanFlags(Ljava/lang/Object;)I
    ...
    .end local v7           #styles:[Ljava/lang/Object;
    :cond_0
    return-void
.end method
...
.method private fixSelectionAndDoNextAction()V
    ...
    const-string v1, "--- cancel handle complete:"
...
.method private insertImageSpan(Landroid/text/style/DynamicDrawableSpan;I)V
    ...
    const-string v0, "--- insertImageSpan:"
    ...
    const-string v0, "--- insertImageSpan: null span was inserted"
...
.method private setSelection()V
    ...
    const-string v4, "EditStyledText.EditorManager"
    ...
    const-string v1, "Select is on, but cursor positions are illigal.:"
...
.method public updateSpanNextToCursor(Landroid/text/Editable;III)V
    ...
    .prologue
    .line 1376
    const-string v16, "EditStyledText.EditorManager"

    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string v18, "updateSpanNext:"
    ...
    .line 1382
    .local v13, spansAfter:[Ljava/lang/Object;
    move-object v5, v13
    ...
    instance-of v0, v0, Lcom/android/ex/editstyledtext/EditStyledText$EditStyledTextSpans$MarqueeSpan;
    ...
    iget-object v0, v0, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->mEST:Lcom/android/ex/editstyledtext/EditStyledText;

    move-object/from16 v16, v0

    invoke-virtual/range {v16 .. v16}, Lcom/android/ex/editstyledtext/EditStyledText;->getText()Landroid/text/Editable;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->findLineStart(Landroid/text/Editable;I)I
    ...
    instance-of v0, v0, Lcom/android/ex/editstyledtext/EditStyledText$EditStyledTextSpans$HorizontalLineSpan;
    ...
    invoke-interface/range {v16 .. v17}, Landroid/text/Editable;->charAt(I)C
...
.method public updateSpanPreviousFromCursor(Landroid/text/Editable;III)V
    ...
    const-string v18, "updateSpanPrevious:"
    ...
    .line 1329
    .local v13, spansBefore:[Ljava/lang/Object;
    move-object v5, v13
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->findLineEnd(Landroid/text/Editable;I)I
    ...
    const-string v17, "updateSpanPrevious: extend span"
    ...
    .restart local v12       #spanend:I
    .restart local v14       #spanstart:I
    .restart local v15       #tempmax:I
    :cond_4
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/ex/editstyledtext/EditStyledText$EditorManager;->mKeepNonLineSpan:Z

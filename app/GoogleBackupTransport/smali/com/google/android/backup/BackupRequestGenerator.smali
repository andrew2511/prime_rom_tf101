...
.method public approximateSize()I
    ...
    check-cast p0, Lcom/google/android/backup/BackupRequestGenerator$Application;

    invoke-static {p0}, Lcom/google/android/backup/BackupRequestGenerator$Application;->access$200(Lcom/google/android/backup/BackupRequestGenerator$Application;)Ljava/util/HashMap;
...
.method public makeAbortRequest()Lcom/google/common/io/protocol/ProtoBuf;
    ...
    invoke-virtual {v4, v5, p0}, Lcom/google/common/io/protocol/ProtoBuf;->setString(ILjava/lang/String;)V
...
.method public makeFinalRequest()Lcom/google/common/io/protocol/ProtoBuf;
    ...
    .line 255
    .local v11, request:Lcom/google/common/io/protocol/ProtoBuf;
    const/16 v17, 0x13
    ...
    iget-boolean v0, v0, Lcom/google/android/backup/BackupRequestGenerator;->mSendInitialize:Z
    ...
    iput-boolean v0, v1, Lcom/google/android/backup/BackupRequestGenerator;->mSendInitialize:Z

    .line 262
    :cond_0
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/google/android/backup/BackupRequestGenerator;->mApplications:Ljava/util/HashMap;
    ...
    .line 263
    .local v4, appEntry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Lcom/google/android/backup/BackupRequestGenerator$Application;>;"
    invoke-interface {v4}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/google/android/backup/BackupRequestGenerator$Application;

    .line 264
    .local v3, app:Lcom/google/android/backup/BackupRequestGenerator$Application;
    invoke-static {v3}, Lcom/google/android/backup/BackupRequestGenerator$Application;->access$200(Lcom/google/android/backup/BackupRequestGenerator$Application;)Ljava/util/HashMap;
    ...
    invoke-static {v3}, Lcom/google/android/backup/BackupRequestGenerator$Application;->access$300(Lcom/google/android/backup/BackupRequestGenerator$Application;)Ljava/util/HashSet;
    ...
    invoke-static {v3}, Lcom/google/android/backup/BackupRequestGenerator$Application;->access$400(Lcom/google/android/backup/BackupRequestGenerator$Application;)Ljava/util/HashSet;
    ...
    .end local v4           #appEntry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Lcom/google/android/backup/BackupRequestGenerator$Application;>;"
    ...
    .line 272
    invoke-static {v3}, Lcom/google/android/backup/BackupRequestGenerator$Application;->access$100(Lcom/google/android/backup/BackupRequestGenerator$Application;)Ljava/lang/String;
    ...
    .line 277
    .local v16, update:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;[B>;"
    const/4 v14, 0x6
    ...
    .line 279
    .local v13, setting:Lcom/google/common/io/protocol/ProtoBuf;
    const/16 v17, 0x1
    ...
    .line 284
    .end local v13           #setting:Lcom/google/common/io/protocol/ProtoBuf;
    .end local v14           #tag:I
    .end local v16           #update:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;[B>;"
    :cond_5
    invoke-static {v3}, Lcom/google/android/backup/BackupRequestGenerator$Application;->access$200(Lcom/google/android/backup/BackupRequestGenerator$Application;)Ljava/util/HashMap;
    ...
    .line 289
    .local v5, delete:Lcom/google/common/io/protocol/ProtoBuf;
    const-string v17, ""
    ...
    .line 294
    .end local v5           #delete:Lcom/google/common/io/protocol/ProtoBuf;
    ...
    .line 296
    .local v15, tempKey:Ljava/lang/String;
    const/16 v17, 0x7
    ...
    .line 297
    .local v9, move:Lcom/google/common/io/protocol/ProtoBuf;
    const/16 v17, 0x8
    ...
    .end local v9           #move:Lcom/google/common/io/protocol/ProtoBuf;
    .end local v15           #tempKey:Ljava/lang/String;
    :cond_8
    invoke-static {v3}, Lcom/google/android/backup/BackupRequestGenerator$Application;->access$400(Lcom/google/android/backup/BackupRequestGenerator$Application;)Ljava/util/HashSet;
    ...
    .line 303
    .end local v3           #app:Lcom/google/android/backup/BackupRequestGenerator$Application;

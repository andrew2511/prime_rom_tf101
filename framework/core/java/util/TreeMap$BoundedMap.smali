...
.field private entrySet:Ljava/util/TreeMap$BoundedMap$BoundedEntrySet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/TreeMap",
...
.field private final fromBound:Ljava/util/TreeMap$Bound;

.field private keySet:Ljava/util/TreeMap$BoundedMap$BoundedKeySet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/TreeMap",
...
.field private final toBound:Ljava/util/TreeMap$Bound;
...
.method public entrySet()Ljava/util/Set;
    ...
    :cond_6
    new-instance v1, Ljava/util/TreeMap$BoundedMap$BoundedEntrySet;

    invoke-direct {v1, p0}, Ljava/util/TreeMap$BoundedMap$BoundedEntrySet;-><init>(Ljava/util/TreeMap$BoundedMap;)V

    iput-object v1, p0, Ljava/util/TreeMap$BoundedMap;->entrySet:Ljava/util/TreeMap$BoundedMap$BoundedEntrySet;
...
.method public navigableKeySet()Ljava/util/NavigableSet;
    ...
    :cond_6
    new-instance v1, Ljava/util/TreeMap$BoundedMap$BoundedKeySet;

    invoke-direct {v1, p0}, Ljava/util/TreeMap$BoundedMap$BoundedKeySet;-><init>(Ljava/util/TreeMap$BoundedMap;)V

    iput-object v1, p0, Ljava/util/TreeMap$BoundedMap;->keySet:Ljava/util/TreeMap$BoundedMap$BoundedKeySet;
...
.method public subMap(Ljava/lang/Object;ZLjava/lang/Object;Z)Ljava/util/NavigableMap;
    ...
    sget-object v2, Ljava/util/TreeMap$Bound;->INCLUSIVE:Ljava/util/TreeMap$Bound;

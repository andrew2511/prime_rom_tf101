...
.method private static copyOfInternal(Ljava/util/Comparator;Ljava/lang/Iterable;Z)Lcom/google/common/collect/ImmutableSortedSet;
    ...
    .line 359
    .local v4, hasSameComparator:Z
    :goto_0
    if-eqz v4, :cond_2

    instance-of v8, p1, Lcom/google/common/collect/ImmutableSortedSet;
    ...
    .line 362
    .local v7, result:Lcom/google/common/collect/ImmutableSortedSet;,"Lcom/google/common/collect/ImmutableSortedSet<TE;>;"
    invoke-virtual {v7}, Lcom/google/common/collect/ImmutableSortedSet;->hasPartialArray()Z
    ...
    .line 379
    .end local v7           #result:Lcom/google/common/collect/ImmutableSortedSet;,"Lcom/google/common/collect/ImmutableSortedSet<TE;>;"
    :goto_1
    return-object v8

    .line 356
    .end local v4           #hasSameComparator:Z
    :cond_1
    const/4 v8, 0x0
    ...
    .line 367
    .restart local v4       #hasSameComparator:Z
    :cond_2
    ...
    .line 376
    invoke-static {v2, p0}, Lcom/google/common/collect/ImmutableSortedSet;->sort([Ljava/lang/Object;Ljava/util/Comparator;)V

    .line 377
    invoke-static {v2, p0}, Lcom/google/common/collect/ImmutableSortedSet;->removeDupes([Ljava/lang/Object;Ljava/util/Comparator;)[Ljava/lang/Object;

    move-result-object v2

    .line 379
    :cond_5
    new-instance v8, Lcom/google/common/collect/RegularImmutableSortedSet;

    invoke-direct {v8, v2, p0}, Lcom/google/common/collect/RegularImmutableSortedSet;-><init>([Ljava/lang/Object;Ljava/util/Comparator;)V
...
.method static hasSameComparator(Ljava/lang/Iterable;Ljava/util/Comparator;)Z
    ...
    .line 416
    .local v2, sortedSet:Ljava/util/SortedSet;,"Ljava/util/SortedSet<*>;"
    ...
    .end local v2           #sortedSet:Ljava/util/SortedSet;,"Ljava/util/SortedSet<*>;"
    :goto_0
    return v3

    .restart local v1       #comparator2:Ljava/util/Comparator;,"Ljava/util/Comparator<*>;"
    .restart local v2       #sortedSet:Ljava/util/SortedSet;,"Ljava/util/SortedSet<*>;"
    :cond_0
    move v3, v4

...
.method private doNotifyDataConnection(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/Phone$DataState;)V
    ...
    .line 110
    .local v7, linkCapabilities:Landroid/net/LinkCapabilities;
    sget-object v0, Lcom/android/internal/telephony/Phone$DataState;->CONNECTED:Lcom/android/internal/telephony/Phone$DataState;

    if-ne p4, v0, :cond_12

    .line 111
    invoke-interface {p1, p3}, Lcom/android/internal/telephony/Phone;->getLinkProperties(Ljava/lang/String;)Landroid/net/LinkProperties;

    move-result-object v6

    .line 112
    invoke-interface {p1, p3}, Lcom/android/internal/telephony/Phone;->getLinkCapabilities(Ljava/lang/String;)Landroid/net/LinkCapabilities;
    ...
    invoke-static {p4}, Lcom/android/internal/telephony/DefaultPhoneNotifier;->convertDataState(Lcom/android/internal/telephony/Phone$DataState;)I
    ...
    invoke-interface {p1}, Lcom/android/internal/telephony/Phone;->getActiveApnHost()Ljava/lang/String;
    ...
    invoke-interface/range {v0 .. v8}, Lcom/android/internal/telephony/ITelephonyRegistry;->notifyDataConnection(IZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/LinkCapabilities;I)V
    :try_end_2c
    .catch Landroid/os/RemoteException; {:try_start_12 .. :try_end_2c} :catch_30

...
.method private syncSettings(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lcom/google/android/gsf/gservices/GservicesProvider;->mDbHelper:Lcom/google/android/gsf/gservices/GservicesProvider$DatabaseHelper;

    move-object v5, v0

    invoke-virtual {v5}, Lcom/google/android/gsf/gservices/GservicesProvider$DatabaseHelper;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 377
    .local v22, values:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    new-instance v19, Landroid/database/MatrixCursor;

    sget-object v5, Lcom/google/android/gsf/gservices/GservicesProvider;->COLUMNS:[Ljava/lang/String;
    ...
    .line 378
    .local v19, mc:Landroid/database/MatrixCursor;
    const/4 v5, 0x1
    ...
    invoke-direct {v0, v1, v2}, Lcom/google/android/gsf/gservices/GservicesProvider;->queryPrefix(Landroid/database/MatrixCursor;[Ljava/lang/String;)V

    .line 380
    :goto_0
    :try_start_0
    invoke-virtual/range {v19 .. v19}, Landroid/database/MatrixCursor;->moveToNext()Z
    ...
    invoke-virtual {v0, v1}, Landroid/database/MatrixCursor;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/database/MatrixCursor;->close()V
    ...
    .line 390
    .local v14, delete:Landroid/database/sqlite/SQLiteStatement;
    ...
    const-string v6, "SELECT name, value FROM "
    ...
    invoke-virtual {v13, v5, v6}, Landroid/database/sqlite/SQLiteDatabase;->rawQuery(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string v6, " (name, value) VALUES (?, ?)"
    ...
    .line 437
    .local v17, insert:Landroid/database/sqlite/SQLiteStatement;
    const/4 v5, 0x1
    ...
    .line 440
    .local v15, e:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .line 446
    .local v20, origValue:Ljava/lang/String;
    :try_start_4
    invoke-interface {v11}, Landroid/database/Cursor;->moveToNext()Z
    ...
    .line 465
    .end local v15           #e:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v16           #i$:Ljava/util/Iterator;
    .end local v18           #key:Ljava/lang/String;
    .end local v20           #origValue:Ljava/lang/String;
    .end local v21           #value:Ljava/lang/String;
    :catchall_2
    move-exception v5
    ...
    .line 450
    .restart local v15       #e:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    .restart local v16       #i$:Ljava/util/Iterator;
    .restart local v18       #key:Ljava/lang/String;
    .restart local v20       #origValue:Ljava/lang/String;
    .restart local v21       #value:Ljava/lang/String;
    :catchall_3
    move-exception v5
    ...
    .end local v16           #i$:Ljava/util/Iterator;
    .end local v17           #insert:Landroid/database/sqlite/SQLiteStatement;
    :cond_a
    return-void
.end method
...
.method public onCreate()Z
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/google/android/gsf/gservices/GservicesProvider;->mPushToSecure:Z
    ...
    const-string v5, "Gservices pushing to system: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/google/android/gsf/gservices/GservicesProvider;->mPushToSystem:Z
    ...
    iget-boolean v5, p0, Lcom/google/android/gsf/gservices/GservicesProvider;->mPushToSecure:Z

...
.method private getLocationProviders()Ljava/util/ArrayList;
    ...
    .line 72
    iget-object v5, p0, Lcom/google/android/googlequicksearchbox/google/LocationHelperBase;->mLocationManager:Lcom/google/android/googlequicksearchbox/google/LocationManagerInterface;

    const/4 v6, 0x0

    invoke-interface {v5, v6}, Lcom/google/android/googlequicksearchbox/google/LocationManagerInterface;->getProviders(Z)Ljava/util/List;
    ...
    .line 74
    :cond_0
    const-string v5, "QSB.LocationHelper"

    const-string v6, "No location providers found."
    ...
    invoke-interface {v5, v2}, Lcom/google/android/googlequicksearchbox/google/LocationManagerInterface;->getProvider(Ljava/lang/String;)Lcom/google/android/googlequicksearchbox/google/LocationManagerInterface$LocationProviderInterface;
    ...
    const-string v6, "No location providers that we want to use."

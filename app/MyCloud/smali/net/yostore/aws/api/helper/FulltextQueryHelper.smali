.class public Lnet/yostore/aws/api/helper/FulltextQueryHelper;
.super Lnet/yostore/aws/api/helper/BaseHelper;
.source "FulltextQueryHelper.java"


# static fields
.field private static final TAG:Ljava/lang/String; = "FulltextQueryHelper"
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;IILnet/yostore/aws/api/entity/FulltextQueryRequest$Kind;Ljava/lang/String;)V
    ...
    .line 28
    iput-object p1, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->keyword:Ljava/lang/String;

    .line 29
    iput-object p2, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->markid:Ljava/lang/String;

    .line 30
    iput p3, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->pagesize:I

    .line 31
    iput p4, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->offset:I

    .line 32
    iput-object p5, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->kind:Lnet/yostore/aws/api/entity/FulltextQueryRequest$Kind;

    .line 33
    iput-object p6, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->ext:Ljava/lang/String;
...
.method protected doApi(Lnet/yostore/aws/api/ApiConfig;)Lnet/yostore/aws/api/entity/ApiResponse;
    ...
    .line 42
    iget-object v3, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->keyword:Ljava/lang/String;

    .line 43
    iget-object v4, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->markid:Ljava/lang/String;

    .line 44
    iget v5, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->pagesize:I

    .line 45
    iget v6, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->offset:I

    .line 46
    iget-object v7, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->kind:Lnet/yostore/aws/api/entity/FulltextQueryRequest$Kind;

    .line 47
    iget-object v8, p0, Lnet/yostore/aws/api/helper/FulltextQueryHelper;->ext:Ljava/lang/String;
    ...
    const-string v1, "FulltextQueryHelper"
    ...
    invoke-virtual {v9}, Lnet/yostore/aws/api/entity/ApiResponse;->getLogmessage()Ljava/lang/String;

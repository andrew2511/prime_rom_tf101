...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, v1, Landroid/app/NativeActivity;->mIMM:Landroid/view/inputmethod/InputMethodManager;

    .line 150
    new-instance v2, Landroid/app/NativeActivity$InputMethodCallback;

    move-object v0, v2

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Landroid/app/NativeActivity$InputMethodCallback;-><init>(Landroid/app/NativeActivity;)V

    move-object v0, v2

    move-object/from16 v1, p0

    iput-object v0, v1, Landroid/app/NativeActivity;->mInputMethodCallback:Landroid/app/NativeActivity$InputMethodCallback;
    ...
    invoke-virtual {v0, v1}, Landroid/view/Window;->takeInputQueue(Landroid/view/InputQueue$Callback;)V
    ...
    invoke-direct {v0, v1}, Landroid/app/NativeActivity$NativeContentView;-><init>(Landroid/content/Context;)V

    move-object v0, v2

    move-object/from16 v1, p0

    iput-object v0, v1, Landroid/app/NativeActivity;->mNativeContentView:Landroid/app/NativeActivity$NativeContentView;

    .line 160
    move-object/from16 v0, p0

    iget-object v0, v0, Landroid/app/NativeActivity;->mNativeContentView:Landroid/app/NativeActivity$NativeContentView;
    ...
    invoke-virtual {v2, v3}, Landroid/os/Bundle;->getString(Ljava/lang/String;)Ljava/lang/String;
    :try_end_a8
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_7f .. :try_end_a8} :catch_e0
    ...
    .restart local v4       #funcname:Ljava/lang/String;
    :catch_e0
    move-exception v2
    ...
    invoke-direct {v2, v3, v13}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct/range {v2 .. v11}, Landroid/app/NativeActivity;->loadNativeCode(Ljava/lang/String;Ljava/lang/String;Landroid/os/MessageQueue;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/content/res/AssetManager;[B)I
    ...
    iput v0, v1, Landroid/app/NativeActivity;->mNativeHandle:I

    .line 198
    move-object/from16 v0, p0

    iget v0, v0, Landroid/app/NativeActivity;->mNativeHandle:I

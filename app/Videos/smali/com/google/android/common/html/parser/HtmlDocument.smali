...
.method public static createText(Ljava/lang/String;)Lcom/google/android/common/html/parser/HtmlDocument$Text;
    .locals 1
    .parameter "text"
    ...
    invoke-static {p0, v0}, Lcom/google/android/common/html/parser/HtmlDocument;->createText(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/common/html/parser/HtmlDocument$Text;
...
.method public filter(Lcom/google/android/common/html/parser/HtmlDocument$MultiplexFilter;)Lcom/google/android/common/html/parser/HtmlDocument;
    .locals 4
    .parameter "filter"

    .prologue
    .line 204
    invoke-interface {p1}, Lcom/google/android/common/html/parser/HtmlDocument$MultiplexFilter;->start()V
    ...
    .line 206
    .local v1, newNodes:Ljava/util/List;,"Ljava/util/List<Lcom/google/android/common/html/parser/HtmlDocument$Node;>;"
    iget-object v3, p0, Lcom/google/android/common/html/parser/HtmlDocument;->nodes:Ljava/util/List;
    ...
    check-cast v2, Lcom/google/android/common/html/parser/HtmlDocument$Node;

    .line 207
    .local v2, node:Lcom/google/android/common/html/parser/HtmlDocument$Node;
    invoke-interface {p1, v2, v1}, Lcom/google/android/common/html/parser/HtmlDocument$MultiplexFilter;->filter(Lcom/google/android/common/html/parser/HtmlDocument$Node;Ljava/util/List;)V

    goto :goto_0

    .line 209
    .end local v2           #node:Lcom/google/android/common/html/parser/HtmlDocument$Node;
    :cond_0
    invoke-interface {p1, v1}, Lcom/google/android/common/html/parser/HtmlDocument$MultiplexFilter;->finish(Ljava/util/List;)V

    .line 210
    new-instance v3, Lcom/google/android/common/html/parser/HtmlDocument;

    invoke-direct {v3, v1}, Lcom/google/android/common/html/parser/HtmlDocument;-><init>(Ljava/util/List;)V
...
.method public getNodes()Ljava/util/List;
    ...
    .prologue
    .line 40
    iget-object v0, p0, Lcom/google/android/common/html/parser/HtmlDocument;->nodes:Ljava/util/List;
...
.method public toHTML()Ljava/lang/String;
    ...
    .line 47
    .local v1, n:Lcom/google/android/common/html/parser/HtmlDocument$Node;
    invoke-virtual {v1, v2}, Lcom/google/android/common/html/parser/HtmlDocument$Node;->toHTML(Ljava/lang/StringBuilder;)V

    goto :goto_0

    .line 49
    .end local v1           #n:Lcom/google/android/common/html/parser/HtmlDocument$Node;
    :cond_0
...
.method public toOriginalHTML()Ljava/lang/String;
    ...
    .line 69
    .local v1, n:Lcom/google/android/common/html/parser/HtmlDocument$Node;
    invoke-virtual {v1, v2}, Lcom/google/android/common/html/parser/HtmlDocument$Node;->toOriginalHTML(Ljava/lang/StringBuilder;)V
...
.method public toXHTML()Ljava/lang/String;
    ...
    .line 56
    .local v1, n:Lcom/google/android/common/html/parser/HtmlDocument$Node;
    invoke-virtual {v1, v2}, Lcom/google/android/common/html/parser/HtmlDocument$Node;->toXHTML(Ljava/lang/StringBuilder;)V

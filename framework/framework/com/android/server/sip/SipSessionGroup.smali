...
.method private static createPeerProfile(Ljavax/sip/message/Request;)Landroid/net/sip/SipProfile;
    ...
    :try_end_37
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_37} :catch_39
    .catch Ljava/text/ParseException; {:try_start_0 .. :try_end_37} :catch_43
...
.method private declared-synchronized getSipSession(Ljava/util/EventObject;)Lcom/android/server/sip/SipSessionGroup$SipSessionImpl;
    ...
    :try_end_7e
    .catchall {:try_start_7c .. :try_end_7e} :catchall_74
...
.method private declared-synchronized process(Ljava/util/EventObject;)V
    ...
    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_35
    .catchall {:try_start_5 .. :try_end_35} :catchall_58
    .catch Ljava/lang/Throwable; {:try_start_5 .. :try_end_35} :catch_3a
    ...
    :try_end_57
    .catchall {:try_start_3c .. :try_end_57} :catchall_58
...
.method declared-synchronized reset(Ljava/lang/String;)V
    ...
    :try_end_3
    .catchall {:try_start_1 .. :try_end_3} :catchall_bb
    ...
    :try_end_78
    .catchall {:try_start_7 .. :try_end_78} :catchall_bb
    ...
    :try_end_92
    .catchall {:try_start_78 .. :try_end_92} :catchall_bb
    .catch Ljavax/sip/InvalidArgumentException; {:try_start_78 .. :try_end_92} :catch_be
    .catch Ljava/util/TooManyListenersException; {:try_start_78 .. :try_end_92} :catch_ca
    ...
    :try_end_b9
    .catchall {:try_start_92 .. :try_end_b9} :catchall_bb
    ...
    throw v7
    :try_end_d4
    .catchall {:try_start_c0 .. :try_end_d4} :catchall_bb
.end method

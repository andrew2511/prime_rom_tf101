.class public Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;
    }
.end annotation
...
# instance fields
.field private m_eStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

.field m_oActivity:Lcom/infraware/common/UxDocViewerBase;

.field m_oAddBookmarkButton:Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;

.field m_oBookmarkAdapter:Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;

.field m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;

.field m_oBookmarkItemList:Ljava/util/ArrayList;
...
.field m_oBookmarkList:Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;

.field private m_oBookmarkOverwriteWarningDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

.field private m_oBookmarkRemoveDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;
...
.field m_oUnitPanel:Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;
...
.method static synthetic $SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    .prologue
    .line 48
    sget-object v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
    ...
    :goto_d0
    sput-object v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
...
.method public constructor <init>(Lcom/infraware/common/UxDocViewerBase;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;)V
    ...
    .line 69
    iput-object v0, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkOverwriteWarningDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    .line 70
    iput-object v0, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkRemoveDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    .line 74
    iput-object p1, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    .line 75
    iget-object v0, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    invoke-virtual {v0}, Lcom/infraware/common/UxDocViewerBase;->getCoreInterface()Lcom/infraware/common/CoCoreFunctionInterface;

    move-result-object v0

    iput-object v0, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oCoreInterface:Lcom/infraware/common/CoCoreFunctionInterface;

    .line 77
    iput-object p2, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_eStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
...
.method public createView()V
    ...
    .line 82
    new-instance v4, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;

    iget-object v5, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    const v6, 0x7f03004a

    invoke-direct {v4, v5, v6}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;-><init>(Landroid/app/Activity;I)V

    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oUnitPanel:Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;

    .line 84
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    const v5, 0x7f0c016a

    invoke-virtual {v4, v5}, Lcom/infraware/common/UxDocViewerBase;->findViewById(I)Landroid/view/View;

    move-result-object v4

    check-cast v4, Landroid/widget/LinearLayout;

    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oHolderLayout:Landroid/widget/LinearLayout;

    .line 85
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oHolderLayout:Landroid/widget/LinearLayout;
    ...
    .line 88
    .local v3, oParams:Landroid/widget/LinearLayout$LayoutParams;
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oHolderLayout:Landroid/widget/LinearLayout;

    iget-object v5, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oUnitPanel:Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;

    invoke-virtual {v5}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;->getNativeView()Landroid/view/ViewGroup;
    ...
    .line 90
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oUnitPanel:Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;

    invoke-virtual {v4, p0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;->registerCommandListener(Lcom/infraware/uxcontrol/uiunit/UiUnitView$OnCommandListener;)V

    .line 92
    new-instance v4, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;

    iget-object v5, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    const v6, 0x7f02031b

    invoke-direct {v4, v5, v6}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;-><init>(Landroid/app/Activity;I)V

    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;
    ...
    .line 95
    .local v0, editFilter:[Landroid/text/InputFilter;
    const/4 v4, 0x0
    ...
    .line 96
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;

    invoke-virtual {v4}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;->getNativeView()Landroid/widget/EditText;
    ...
    .line 98
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_eStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    sget-object v5, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Bookclip:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    ...
    invoke-virtual {v5}, Lcom/infraware/common/UxDocViewerBase;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v4, v5}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;->setHint(Ljava/lang/CharSequence;)V
    ...
    new-instance v5, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$1;

    invoke-direct {v5, p0}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$1;-><init>(Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;)V
    ...
    iget-object v6, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;

    invoke-virtual {v4, v5, v6}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;->addComponent(ILcom/infraware/uxcontrol/uiunit/UiUnitView;)Z

    .line 115
    new-instance v4, Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;

    iget-object v5, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    const v6, 0x7f020009

    invoke-direct {v4, v5, v6}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;-><init>(Landroid/app/Activity;I)V

    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oAddBookmarkButton:Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;

    .line 116
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oAddBookmarkButton:Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;
    ...
    sget-object v6, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;->eUC_BookclipAdd:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;

    invoke-virtual {v4, v5, v6}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;->setEvent(Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitEvent;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;)V
    ...
    invoke-virtual {v4, v5}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;->setImage(I)V
    ...
    iget-object v6, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oAddBookmarkButton:Lcom/infraware/uxcontrol/uiunit/UiUnit_ImageButton;
    ...
    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkItemList:Ljava/util/ArrayList;

    .line 122
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oCoreInterface:Lcom/infraware/common/CoCoreFunctionInterface;

    invoke-virtual {v4}, Lcom/infraware/common/CoCoreFunctionInterface;->getBookClipList()Ljava/util/ArrayList;

    move-result-object v2

    .line 124
    .local v2, oBookclipList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const/4 v1, 0x0
    ...
    invoke-direct {v4, v5, v8, v6}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;-><init>(Landroid/app/Activity;ILjava/util/List;)V

    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkList:Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;

    .line 130
    new-instance v4, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;

    iget-object v5, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    iget-object v6, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkItemList:Ljava/util/ArrayList;

    iget-object v7, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkList:Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;

    invoke-direct {v4, v5, v8, v6, v7}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;-><init>(Landroid/content/Context;ILjava/util/List;Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;)V

    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkAdapter:Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;

    .line 132
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkList:Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;

    iget-object v5, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkAdapter:Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;

    invoke-virtual {v4, v5}, Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;->setCustomAdapter(Lcom/infraware/uxcontrol/uiunit/UiCustomAdapter;)V
    ...
    iget-object v6, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkList:Lcom/infraware/uxcontrol/uiunit/UiUnit_ListControl;
    ...
    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oIncomingAnimation:Landroid/view/animation/Animation;
    ...
    iput-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oOutgoingAnimation:Landroid/view/animation/Animation;

    .line 143
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oOutgoingAnimation:Landroid/view/animation/Animation;

    new-instance v5, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$2;

    invoke-direct {v5, p0}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$2;-><init>(Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;)V
    ...
    .line 100
    .end local v1           #i:I
    .end local v2           #oBookclipList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    :cond_1
    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_eStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    sget-object v5, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Bookmark:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    ...
    .restart local v2       #oBookclipList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    :cond_2
    iget-object v5, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkItemList:Ljava/util/ArrayList;

    new-instance v6, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarItem;
    ...
    invoke-direct {v6, v4}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarItem;-><init>(Ljava/lang/String;)V
...
.method public hideSoftInput()V
    ...
    .prologue
    .line 334
    iget-object v1, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    const-string v2, "input_method"

    invoke-virtual {v1, v2}, Lcom/infraware/common/UxDocViewerBase;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 337
    iget-object v1, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;
...
.method public isVisible()Z
    ...
    .prologue
    .line 191
    iget-object v0, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oUnitPanel:Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;
    ...
    invoke-virtual {v0}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;->isVisible()Z
...
.method public varargs onCommand(Lcom/infraware/uxcontrol/uiunit/UiUnitView;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;[Ljava/lang/Object;)V
    ...
    .prologue
    .line 198
    invoke-static {}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oCoreInterface:Lcom/infraware/common/CoCoreFunctionInterface;

    move-object v13, v0

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkItemList:Ljava/util/ArrayList;
    ...
    .end local p0
    check-cast p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarItem;

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarItem;->m_strName:Ljava/lang/String;

    move-object v14, v0

    invoke-virtual {v13, v14}, Lcom/infraware/common/CoCoreFunctionInterface;->applyBookClip(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    move-object v13, v0

    iget v13, v13, Lcom/infraware/common/UxDocViewerBase;->m_nEV_VIEW_MODE:I
    ...
    check-cast v6, Lcom/infraware/word/UxWordEditorActivity;

    .line 210
    .local v6, oEditor:Lcom/infraware/word/UxWordEditorActivity;
    invoke-virtual {v6}, Lcom/infraware/word/UxWordEditorActivity;->getToolBarUpdater()Lcom/infraware/common/UxToolBarUpdater;

    move-result-object p1

    .end local p1
    check-cast p1, Lcom/infraware/word/UxWordToolBarUpdater;

    invoke-virtual/range {p1 .. p1}, Lcom/infraware/word/UxWordToolBarUpdater;->canAddBookMark()Z
    ...
    invoke-virtual {v14, v15}, Lcom/infraware/common/UxDocViewerBase;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v18}, Lcom/infraware/common/UxDocViewerBase;->getString(I)Ljava/lang/String;
    ...
    .line 213
    .local v12, szMessage:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v13, v12, v14}, Lcom/infraware/common/UxDocViewerBase;->showToast(Ljava/lang/String;I)V

    goto/16 :goto_0

    .line 218
    .end local v6           #oEditor:Lcom/infraware/word/UxWordEditorActivity;
    .end local v12           #szMessage:Ljava/lang/String;
    :cond_1
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;

    move-object v13, v0

    invoke-virtual {v13}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;->getLength()I
    ...
    invoke-virtual {v13}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;->getText()Ljava/lang/CharSequence;
    ...
    .line 224
    .local v9, strCurrentBookmarkName:Ljava/lang/String;
    if-eqz v9, :cond_0
    ...
    .line 228
    .local v8, strCompressedString:Ljava/lang/String;
    if-eqz v8, :cond_0
    ...
    invoke-virtual {v13, v8}, Lcom/infraware/common/CoCoreFunctionInterface;->addBookClip(Ljava/lang/String;)I
    ...
    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_eStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    move-object v13, v0

    sget-object v14, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Bookmark:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    ...
    invoke-virtual {v14}, Lcom/infraware/common/UxDocViewerBase;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v13, v14}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;->setText(Ljava/lang/CharSequence;)V

    .line 281
    invoke-virtual/range {p0 .. p0}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->hideSoftInput()V

    goto/16 :goto_0

    .line 233
    .end local v5           #nReturn:I
    :cond_3
    move-object/from16 v0, p0
    ...
    check-cast p1, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarItem;
    ...
    invoke-virtual {v13}, Lcom/infraware/common/UxDocViewerBase;->getResources()Landroid/content/res/Resources;

    move-result-object v7

    .line 237
    .local v7, oResource:Landroid/content/res/Resources;
    const/4 v11, 0x0

    .line 238
    .local v11, strDeleteTitle:Ljava/lang/String;
    const/4 v10, 0x0

    .line 239
    .local v10, strDeleteMessage:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    sget-object v15, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Dialog1Button:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    invoke-direct {v13, v14, v11, v10, v15}, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;-><init>(Landroid/app/Activity;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;)V

    move-object v0, v13

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkOverwriteWarningDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    .line 250
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkOverwriteWarningDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;
    ...
    sget-object v14, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Bookclip:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    ...
    .line 231
    .end local v7           #oResource:Landroid/content/res/Resources;
    .end local v10           #strDeleteMessage:Ljava/lang/String;
    .end local v11           #strDeleteTitle:Ljava/lang/String;
    :cond_6
    ...
    new-instance v14, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarItem;

    invoke-direct {v14, v8}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarItem;-><init>(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkAdapter:Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;

    move-object v13, v0

    invoke-virtual {v13}, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel$BookmarkAdapter;->notifyDataSetChanged()V
    ...
    .end local v2           #i:I
    .end local v5           #nReturn:I
    .end local v8           #strCompressedString:Ljava/lang/String;
    .end local v9           #strCurrentBookmarkName:Ljava/lang/String;
    .restart local p1
    :pswitch_4
    move-object/from16 v0, p0
    ...
    .line 287
    .restart local v7       #oResource:Landroid/content/res/Resources;
    const v13, 0x7f0a02a7
    ...
    .line 291
    .restart local v11       #strDeleteTitle:Ljava/lang/String;
    new-instance v13, Ljava/lang/Integer;
    ...
    .line 303
    .restart local v10       #strDeleteMessage:Ljava/lang/String;
    new-instance v13, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;
    ...
    sget-object v15, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Dialog2Button:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    ...
    iput-object v0, v1, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkRemoveDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    .line 304
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkRemoveDlg:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    move-object v13, v0

    sget-object v14, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;->eUC_DialogPositiveDismiss:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;

    invoke-virtual {v13, v14, v3}, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;->setPositiveDismissCommand(Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;I)V
    ...
    instance-of v0, v0, Lcom/infraware/uxcontrol/uiunit/UiUnit_Dialog;
    ...
    invoke-virtual {v13, v14}, Lcom/infraware/common/CoCoreFunctionInterface;->deleteBookClip(Ljava/lang/String;)Ljava/util/ArrayList;
...
.method public show(Z)V
    ...
    .line 160
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oUnitPanel:Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;

    invoke-virtual {v3, p1}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;->show(Z)V

    .line 161
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oHolderLayout:Landroid/widget/LinearLayout;

    iget-object v4, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oIncomingAnimation:Landroid/view/animation/Animation;

    invoke-virtual {v3, v4}, Landroid/widget/LinearLayout;->startAnimation(Landroid/view/animation/Animation;)V

    .line 163
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oCoreInterface:Lcom/infraware/common/CoCoreFunctionInterface;

    invoke-virtual {v3}, Lcom/infraware/common/CoCoreFunctionInterface;->getBookClipList()Ljava/util/ArrayList;

    move-result-object v0

    .line 164
    .local v0, oBookclipList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    if-eqz v0, :cond_0
    ...
    .line 167
    .local v2, strDefaultValueBuilder:Ljava/lang/StringBuilder;
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_eStyle:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    sget-object v4, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Bookmark:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    if-ne v3, v4, :cond_1

    .line 168
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;

    const v4, 0x7f0a00a0

    invoke-virtual {v3, v4}, Lcom/infraware/common/UxDocViewerBase;->getString(I)Ljava/lang/String;
    ...
    .line 173
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;

    invoke-virtual {v3, v2}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;->setText(Ljava/lang/CharSequence;)V

    .line 174
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oBookmarkEdit:Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;

    invoke-virtual {v3}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Edit;->getNativeView()Landroid/widget/EditText;
    ...
    .line 187
    .end local v0           #oBookclipList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .end local v2           #strDefaultValueBuilder:Ljava/lang/StringBuilder;
    :cond_0
    :goto_1
    return-void

    .line 170
    .restart local v0       #oBookclipList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .restart local v2       #strDefaultValueBuilder:Ljava/lang/StringBuilder;
    :cond_1
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oActivity:Lcom/infraware/common/UxDocViewerBase;
    ...
    invoke-virtual {v3, v4}, Lcom/infraware/common/UxDocViewerBase;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 180
    .local v1, oInputMethodManager:Landroid/view/inputmethod/InputMethodManager;
    if-eqz v1, :cond_3

    .line 182
    iget-object v3, p0, Lcom/infraware/uxcontrol/uicontrol/common/UiBookmarkPanel;->m_oUnitPanel:Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;

    invoke-virtual {v3}, Lcom/infraware/uxcontrol/uiunit/UiUnit_Panel;->getNativeView()Landroid/view/ViewGroup;

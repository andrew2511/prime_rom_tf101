...
.field private static final LOG_POWER:Z
...
.field private mLastPadUsbOnline:Z
...
.method static constructor <clinit>()V
    ...
    :goto_13
    sput-boolean v0, Lcom/android/server/BatteryService;->LOG_POWER:Z
...
.method private captureBatteryDrainInfo()V
    .registers 4
    ...
    const-string v2, "@PowerManagement: AC: "
...
.method private final logBatteryStats()V
    ...
    :try_end_26
    .catchall {:try_start_1f .. :try_end_26} :catchall_cd
    .catch Landroid/os/RemoteException; {:try_start_1f .. :try_end_26} :catch_69
    .catch Ljava/io/IOException; {:try_start_1f .. :try_end_26} :catch_9d
    ...
    .catch Landroid/os/RemoteException; {:try_start_26 .. :try_end_2b} :catch_130
    ...
    .catch Landroid/os/RemoteException; {:try_start_2b .. :try_end_3d} :catch_135
    .catch Ljava/io/IOException; {:try_start_2b .. :try_end_3d} :catch_12a
    ...
    :try_end_42
    .catch Ljava/io/IOException; {:try_start_3f .. :try_end_42} :catch_114
    ...
    :try_end_72
    .catchall {:try_start_6b .. :try_end_72} :catchall_cd
    ...
    :try_end_77
    .catch Ljava/io/IOException; {:try_start_74 .. :try_end_77} :catch_101
    ...
    invoke-virtual {v4}, Ljava/io/FileOutputStream;->close()V
    :try_end_ab
    .catch Ljava/io/IOException; {:try_start_a8 .. :try_end_ab} :catch_10b
    ...
    invoke-virtual {v4}, Ljava/io/FileOutputStream;->close()V
    :try_end_d3
    .catch Ljava/io/IOException; {:try_start_d0 .. :try_end_d3} :catch_f8
...
.method private processValues()V
    ...
    :try_end_24
    .catch Landroid/os/RemoteException; {:try_start_13 .. :try_end_24} :catch_24a
    ...
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mPadUsbOnline:Z

    iget-boolean v1, p0, Lcom/android/server/BatteryService;->mLastPadUsbOnline:Z
    ...
    :cond_18a
    :goto_18a
    sget-boolean v0, Lcom/android/server/BatteryService;->LOG_POWER:Z
    ...
    .line 395
    :cond_19a
    invoke-direct {p0}, Lcom/android/server/BatteryService;->captureBatteryDrainInfo()V
    ...
    iput-boolean v0, p0, Lcom/android/server/BatteryService;->mLastPadUsbOnline:Z
...
.method private final sendIntent()V
    ...
    .line 456
    const-string v2, "usb_wakeup"

    iget-boolean v3, p0, Lcom/android/server/BatteryService;->mPadUsbOnline:Z
    ...
    iget v4, p0, Lcom/android/server/BatteryService;->mDockBatteryStatus:I
    ...
    iget v4, p0, Lcom/android/server/BatteryService;->mDockBatteryLevel:I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v1, "  EPAD USB powered: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Lcom/android/server/BatteryService;->mPadUsbOnline:Z
    ...
    const-string v1, "  dock status: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v1, p0, Lcom/android/server/BatteryService;->mDockBatteryStatus:I
    ...
    const-string v1, "  dock level: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v1, p0, Lcom/android/server/BatteryService;->mDockBatteryLevel:I
    ...
    monitor-exit p0
    :try_end_168
    .catchall {:try_start_39 .. :try_end_168} :catchall_166
...
.method final getBatteryVoltage()I
    .registers 2

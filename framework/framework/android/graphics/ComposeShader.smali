...
.method public constructor <init>(Landroid/graphics/Shader;Landroid/graphics/Shader;Landroid/graphics/Xfermode;)V
    ...
    .line 42
    iget v1, p1, Landroid/graphics/Shader;->native_instance:I

    iget v2, p2, Landroid/graphics/Shader;->native_instance:I

    if-eqz p3, :cond_2f

    iget v3, p3, Landroid/graphics/Xfermode;->native_instance:I

    :goto_10
    invoke-static {v1, v2, v3}, Landroid/graphics/ComposeShader;->nativeCreate1(III)I
    ...
    iget v2, p1, Landroid/graphics/Shader;->native_shader:I

    iget v3, p2, Landroid/graphics/Shader;->native_shader:I

    if-eqz v0, :cond_28

    iget v4, v0, Landroid/graphics/PorterDuff$Mode;->nativeInt:I

    :cond_28
    invoke-static {v1, v2, v3, v4}, Landroid/graphics/ComposeShader;->nativePostCreate2(IIII)I
    ...
    iget v4, p3, Landroid/graphics/Xfermode;->native_instance:I

    :cond_3b
    invoke-static {v1, v2, v3, v4}, Landroid/graphics/ComposeShader;->nativePostCreate1(IIII)I

...
.method static shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 62
    .local v4, manager:Lcom/android/settings/bluetooth/LocalBluetoothManager;
    if-nez v4, :cond_0
    ...
    .restart local p1
    :cond_0
    invoke-virtual {v4}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->isForegroundActivity()Z
    ...
    const-string p0, "discoverable_end_timestamp"
    ...
    .line 77
    .local v2, lastDiscoverableEndTime:J
    ...
    .line 79
    .end local v2           #lastDiscoverableEndTime:J
    const/4 p0, 0x1
    ...
    .line 84
    .local p0, adapter:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    if-eqz p0, :cond_3

    invoke-virtual {p0}, Lcom/android/settings/bluetooth/LocalBluetoothAdapter;->isDiscovering()Z

    move-result p0

    .end local p0           #adapter:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    if-eqz p0, :cond_3
    ...
    .line 86
    :cond_3
    const-string p0, "last_discovering_time"
    ...
    .line 93
    const-string p0, "last_selected_device"

    const/4 v2, 0x0

    invoke-interface {v5, p0, v2}, Landroid/content/SharedPreferences;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    .line 96
    .local p0, lastSelectedDevice:Ljava/lang/String;
    invoke-virtual {p1, p0}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result p0

    .end local p0           #lastSelectedDevice:Ljava/lang/String;
    if-eqz p0, :cond_5

    .line 97
    const-string p0, "last_selected_device_time"
    ...
    .line 99
    .end local p1
    .local p0, lastDeviceSelectedTime:J
    ...
    .line 101
    .end local p0           #lastDeviceSelectedTime:J
    const/4 p0, 0x1

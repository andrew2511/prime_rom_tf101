...
.method public buildRequest(Ljava/lang/String;Ljava/lang/Object;)Lcom/google/api/client/http/HttpRequest;
    ...
    iget-object v0, v0, Lcom/google/api/client/googleapis/json/DiscoveryDocument;->transport:Lcom/google/api/client/googleapis/GoogleTransport;

    move-object/from16 v16, v0

    .line 151
    .local v16, transport:Lcom/google/api/client/googleapis/GoogleTransport;
    if-nez v16, :cond_0

    .line 152
    new-instance v20, Ljava/lang/IllegalArgumentException;

    const-string v21, "missing transport"
    ...
    iget-object v0, v0, Lcom/google/api/client/googleapis/json/DiscoveryDocument;->serviceDefinition:Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$ServiceDefinition;

    move-object v15, v0

    .line 156
    .local v15, serviceDefinition:Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$ServiceDefinition;
    move-object v0, v15

    move-object/from16 v1, p1

    invoke-virtual {v0, v1}, Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$ServiceDefinition;->getResourceMethod(Ljava/lang/String;)Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$Method;

    move-result-object v8

    .line 158
    .local v8, method:Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$Method;
    if-nez v8, :cond_1
    ...
    const-string v22, "unrecognized method: "
    ...
    .line 163
    :cond_1
    iget-object v14, v8, Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$Method;->httpMethod:Ljava/lang/String;

    .line 164
    .local v14, restMethod:Ljava/lang/String;
    ...
    .line 165
    invoke-virtual/range {v16 .. v16}, Lcom/google/api/client/googleapis/GoogleTransport;->buildGetRequest()Lcom/google/api/client/http/HttpRequest;
    ...
    .line 176
    .local v13, requestMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .end local v13           #requestMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .line 169
    invoke-virtual/range {v16 .. v16}, Lcom/google/api/client/googleapis/GoogleTransport;->buildPutRequest()Lcom/google/api/client/http/HttpRequest;
    ...
    .line 171
    invoke-virtual/range {v16 .. v16}, Lcom/google/api/client/googleapis/GoogleTransport;->buildDeleteRequest()Lcom/google/api/client/http/HttpRequest;
    ...
    .end local v12           #request:Lcom/google/api/client/http/HttpRequest;
    :cond_6
    invoke-virtual/range {v16 .. v16}, Lcom/google/api/client/googleapis/GoogleTransport;->buildPatchRequest()Lcom/google/api/client/http/HttpRequest;
    ...
    .restart local v13       #requestMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    :cond_7
    new-instance v17, Lcom/google/api/client/http/GenericUrl;

    move-object v0, v15

    iget-object v0, v0, Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$ServiceDefinition;->baseUrl:Ljava/lang/String;
    ...
    iget-object v11, v8, Lcom/google/api/client/googleapis/json/DiscoveryDocument$Model$Method;->pathUrl:Ljava/lang/String;

    .line 186
    .local v11, pathUrl:Ljava/lang/String;
    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    .line 187
    .local v10, pathBuf:Ljava/lang/StringBuilder;
    const/4 v4, 0x0
    ...
    const-string v22, "missing required path parameter: "

.class public Lcom/google/image/compression/jpeg/JpegUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/image/compression/jpeg/JpegUtil;->JPEG_QUANT_TABLES:[[B
    ...
    sput-object v0, Lcom/google/image/compression/jpeg/JpegUtil;->imageIoScaleFactor:[I
...
.method public static declared-synchronized getQuantTable(III)[B
    ...
    const-class v0, Lcom/google/image/compression/jpeg/JpegUtil;
    ...
    sget-object v2, Lcom/google/image/compression/jpeg/JpegUtil;->JPEG_QUANT_TABLES:[[B
    ...
    invoke-static {v4, p1, p2}, Lcom/google/image/compression/jpeg/JpegUtil;->getScaledQuantizationFactor(III)B
...
.method public static getScaledQuantizationFactor(III)B
    ...
    sget-object v2, Lcom/google/image/compression/jpeg/JpegUtil;->imageIoScaleFactor:[I
...
.method static prependStandardHeader([BII[BILcom/google/image/compression/jpeg/JpegHeaderParams;)V
    .locals 7

    invoke-virtual {p5}, Lcom/google/image/compression/jpeg/JpegHeaderParams;->getVariant()I

    move-result v2

    invoke-virtual {p5}, Lcom/google/image/compression/jpeg/JpegHeaderParams;->getWidth()I

    move-result v3

    invoke-virtual {p5}, Lcom/google/image/compression/jpeg/JpegHeaderParams;->getHeight()I

    move-result v4

    invoke-virtual {p5}, Lcom/google/image/compression/jpeg/JpegHeaderParams;->getQuality()I

    move-result v5

    invoke-virtual {p5}, Lcom/google/image/compression/jpeg/JpegHeaderParams;->getQualityAlgorithm()I
    ...
    :cond_0
    invoke-static {v2}, Lcom/google/image/compression/jpeg/GenerateJpegHeader;->getHeaderLength(I)I
    ...
    invoke-static/range {v0 .. v6}, Lcom/google/image/compression/jpeg/GenerateJpegHeader;->generate([BIIIIII)I
...
.method public static uncompactJpeg([B)[B
    ...
    invoke-static {p0, v0, v1}, Lcom/google/image/compression/jpeg/JpegUtil;->uncompactJpeg([BII)[B
...
.method public static uncompactJpeg([BII)[B
    ...
    :try_start_0
    invoke-static {v1}, Lcom/google/image/compression/jpeg/GenerateJpegHeader;->getHeaderLength(I)I
    :try_end_0
    ...
    new-instance v0, Lcom/google/image/compression/jpeg/JpegHeaderParams;

    invoke-direct/range {v0 .. v6}, Lcom/google/image/compression/jpeg/JpegHeaderParams;-><init>(IIIIII)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/google/image/compression/jpeg/JpegUtil;->prependStandardHeader([BII[BILcom/google/image/compression/jpeg/JpegHeaderParams;)V

...
.method public static getOrMakeSyncAdapter(Landroid/content/Context;)Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter;
    ...
    .prologue
    .line 29
    sget-object v1, Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapterService;->sSyncAdapterLock:Ljava/lang/Object;

    monitor-enter v1

    .line 30
    :try_start_0
    sget-object v2, Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapterService;->sSyncAdapter:Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter;
    ...
    invoke-virtual {v2, p0, v3, v4}, Lcom/google/chrome/bookmarks/sync/api/Factory;->createSyncClient(Landroid/content/Context;ILjava/lang/String;)Lcom/google/chrome/bookmarks/sync/api/ChromeSyncClient;

    move-result-object v0

    .line 35
    .local v0, syncClient:Lcom/google/chrome/bookmarks/sync/api/ChromeSyncClient;
    new-instance v2, Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter;

    invoke-direct {v2, p0, v0}, Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter;-><init>(Landroid/content/Context;Lcom/google/chrome/bookmarks/sync/api/ChromeSyncClient;)V

    sput-object v2, Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapterService;->sSyncAdapter:Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter;

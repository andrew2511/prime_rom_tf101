.class public Lcom/infraware/filemanager/FmUpdateManager;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/infraware/filemanager/FmUpdateManager$FmCloseReceiver;,
        Lcom/infraware/filemanager/FmUpdateManager$FmUpdateReceiver;
    }
.end annotation
...
.field private static final SHOW_ERROR:I = 0xc8

.field private static final UPDATE_START:I = 0x64


# instance fields
.field private mCloseReceiver:Lcom/infraware/filemanager/FmUpdateManager$FmCloseReceiver;

.field private mConnection:Landroid/content/ServiceConnection;

.field private mIsSubUpdate:Z

.field private mUpdateReceiver:Lcom/infraware/filemanager/FmUpdateManager$FmUpdateReceiver;

.field private m_bCancel:Z

.field private m_nProgressStatus:I

.field private m_oActivity:Landroid/app/Activity;

.field private m_oHandler:Landroid/os/Handler;

.field private m_oNetworkConfirmMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

.field private m_oNetworkErrorMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

.field private m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

.field private m_oSettingActivityHandler:Landroid/os/Handler;

.field m_oToast:Landroid/widget/Toast;

.field private m_oUpdateBinder:Lcom/infraware/filemanager/FmUpdateService;
...
.method static synthetic $SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    .prologue
    .line 32
    sget-object v0, Lcom/infraware/filemanager/FmUpdateManager;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
    ...
    :goto_d0
    sput-object v0, Lcom/infraware/filemanager/FmUpdateManager;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand:[I
...
.method public constructor <init>(Landroid/app/Activity;Landroid/os/Handler;)V
    ...
    .line 53
    iput-boolean v10, p0, Lcom/infraware/filemanager/FmUpdateManager;->mIsSubUpdate:Z

    .line 55
    const-string v6, "https://office1.infraware.net/update/PolarisOffice.xml"

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strUpdateURL:Ljava/lang/String;

    .line 56
    const-string v6, "https://office2.infraware.net/update/PolarisOffice.xml"

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strSubUpdateURL:Ljava/lang/String;

    .line 68
    iput v10, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_nProgressStatus:I

    .line 73
    iput-object v11, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oToast:Landroid/widget/Toast;

    .line 74
    iput-boolean v10, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_bCancel:Z

    .line 131
    new-instance v6, Lcom/infraware/filemanager/FmUpdateManager$1;

    invoke-direct {v6, p0}, Lcom/infraware/filemanager/FmUpdateManager$1;-><init>(Lcom/infraware/filemanager/FmUpdateManager;)V

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->mConnection:Landroid/content/ServiceConnection;

    .line 77
    iput-object p1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    .line 78
    iput-object p2, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oSettingActivityHandler:Landroid/os/Handler;

    .line 80
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;
    ...
    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strVersion:Ljava/lang/String;
    ...
    const-string v6, "com.infraware.polaris.office.ACTION_DOWNLOAD_COMPLETE"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 84
    const-string v6, "com.infraware.polaris.office.ACTION_DISABLE_CONFIRM_VERSION"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 85
    const-string v6, "com.infraware.polaris.office.ACTION_LATEST_VERSION"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 86
    const-string v6, "com.infraware.polaris.office.ACTION_CONNECTION_ERROR"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 87
    const-string v6, "com.infraware.polaris.office.ACTION_NETWORK_ERROR"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 88
    const-string v6, "com.infraware.polaris.office.ACTION_FILE_WRITE_ERROR"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 89
    const-string v6, "com.infraware.polaris.office.ACTION_USER_CANCEL"

    invoke-virtual {v0, v6}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 91
    new-instance v6, Lcom/infraware/filemanager/FmUpdateManager$FmUpdateReceiver;

    invoke-direct {v6, p0}, Lcom/infraware/filemanager/FmUpdateManager$FmUpdateReceiver;-><init>(Lcom/infraware/filemanager/FmUpdateManager;)V

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->mUpdateReceiver:Lcom/infraware/filemanager/FmUpdateManager$FmUpdateReceiver;

    .line 92
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    iget-object v7, p0, Lcom/infraware/filemanager/FmUpdateManager;->mUpdateReceiver:Lcom/infraware/filemanager/FmUpdateManager$FmUpdateReceiver;
    ...
    .line 94
    new-instance v6, Lcom/infraware/filemanager/FmUpdateManager$2;

    invoke-direct {v6, p0}, Lcom/infraware/filemanager/FmUpdateManager$2;-><init>(Lcom/infraware/filemanager/FmUpdateManager;)V

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oHandler:Landroid/os/Handler;

    .line 107
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    invoke-static {v6, v11, v10}, Landroid/widget/Toast;->makeText(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;

    move-result-object v6

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oToast:Landroid/widget/Toast;
    ...
    .line 110
    .local v4, szTitle:Ljava/lang/CharSequence;
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;
    ...
    .line 111
    .local v3, szMessage:Ljava/lang/CharSequence;
    ...
    .line 112
    .local v5, usButton:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;
    new-instance v6, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    iget-object v7, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    invoke-direct {v6, v7, v4, v3, v5}, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;-><init>(Landroid/app/Activity;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;)V

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oNetworkConfirmMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    .line 113
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oNetworkConfirmMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    sget-object v7, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;->eUC_DialogNegativeDismiss:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;

    invoke-virtual {v6, v7, v10}, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;->setNagativeDismissCommand(Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;I)V
    ...
    invoke-virtual {v6, p0}, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;->registerCommandListener(Lcom/infraware/uxcontrol/uiunit/UiUnitView$OnCommandListener;)V
    ...
    iget-object v8, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    invoke-virtual {v8, v12}, Landroid/app/Activity;->getText(I)Ljava/lang/CharSequence;

    move-result-object v8

    sget-object v9, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;->eUS_Dialog1Button:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;

    invoke-direct {v6, v7, v8, v11, v9}, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;-><init>(Landroid/app/Activity;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitStyle;)V

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oNetworkErrorMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    .line 118
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oNetworkErrorMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;
    ...
    .line 121
    .local v2, strTitle:Ljava/lang/CharSequence;
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;
    ...
    .line 123
    .local v1, strMessage:Ljava/lang/CharSequence;
    new-instance v6, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

    iget-object v7, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    invoke-direct {v6, v7}, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;-><init>(Landroid/app/Activity;)V

    iput-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

    .line 125
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

    invoke-virtual {v6, v2, v10}, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;->createView(Ljava/lang/CharSequence;Z)V

    .line 126
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

    invoke-virtual {v6, v2, v1}, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;->setProgressText(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v6, v7}, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;->setCancelable(Z)V

    .line 128
    iget-object v6, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

    invoke-virtual {v6, p0}, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;->registerCommandListener(Lcom/infraware/uxcontrol/uiunit/UiUnitView$OnCommandListener;)V

    .line 129
    return-void
.end method

.method static synthetic access$0(Lcom/infraware/filemanager/FmUpdateManager;Lcom/infraware/filemanager/FmUpdateService;)V
    .locals 0
    .parameter
    .parameter
    ...
    .prologue
    .line 59
    iput-object p1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oUpdateBinder:Lcom/infraware/filemanager/FmUpdateService;

    return-void
.end method

.method static synthetic access$1(Lcom/infraware/filemanager/FmUpdateManager;)Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;
    .locals 1
    .parameter

    .prologue
    .line 71
    iget-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

    return-object v0
.end method

.method static synthetic access$2(Lcom/infraware/filemanager/FmUpdateManager;)Landroid/app/Activity;
    .locals 1
    .parameter

    .prologue
    .line 63
    iget-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    return-object v0
.end method

.method static synthetic access$3(Lcom/infraware/filemanager/FmUpdateManager;)Ljava/lang/String;
    .locals 1
    .parameter

    .prologue
    .line 57
    iget-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strVersion:Ljava/lang/String;
...
# virtual methods
.method public getCurtentVersionName()V
    .locals 2
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strVersion:Ljava/lang/String;
...
.method public varargs onCommand(Lcom/infraware/uxcontrol/uiunit/UiUnitView;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;[Ljava/lang/Object;)V
    ...
    .line 242
    invoke-static {}, Lcom/infraware/filemanager/FmUpdateManager;->$SWITCH_TABLE$com$infraware$uxcontrol$uiunit$UiEnum$EUnitCommand()[I
    ...
    .line 244
    :sswitch_0
    iget-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oHandler:Landroid/os/Handler;
    ...
    .line 247
    :sswitch_1
    invoke-virtual {p0, v2}, Lcom/infraware/filemanager/FmUpdateManager;->onStopService(I)Z
    ...
    iput-boolean v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_bCancel:Z
...
.method public onInstall(Ljava/lang/String;)V
    ...
    .line 263
    iget-object v2, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;
...
.method public onSendBroadcastMsg()V
    ...
    const-string v1, "com.infraware.docMaster.ACTION_SETTING"
    ...
    .line 167
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;
...
.method public onStopService(I)Z
    ...
    .line 294
    iget-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oUpdateBinder:Lcom/infraware/filemanager/FmUpdateService;
    ...
    iput-boolean v2, v0, Lcom/infraware/filemanager/FmUpdateService;->mThreadStatus:Z

    .line 296
    iget-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->mConnection:Landroid/content/ServiceConnection;
    ...
    iput-object v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oUpdateBinder:Lcom/infraware/filemanager/FmUpdateService;

    .line 300
    :cond_0
    iget-boolean v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_bCancel:Z

    if-eqz v0, :cond_1

    .line 301
    iput-boolean v2, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_bCancel:Z
    ...
    invoke-virtual {v0, v2}, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;->show(Z)V
    ...
    sget-object v1, Lcom/infraware/filemanager/FmUpdateService;->mstrFileName:Ljava/lang/String;
    ...
    .line 315
    invoke-virtual {p0, v0}, Lcom/infraware/filemanager/FmUpdateManager;->onInstall(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/infraware/filemanager/FmUpdateManager;->showError(I)V

    goto :goto_1

    .line 324
    :pswitch_3
    invoke-virtual {p0, v3}, Lcom/infraware/filemanager/FmUpdateManager;->showError(I)V

    goto :goto_1

    .line 328
    :pswitch_4
    const-string v0, "FmUpdateManager"

    const-string v1, "onStopService::CoNotification.Error"
    ...
    .line 333
    :pswitch_5
    iget-boolean v0, p0, Lcom/infraware/filemanager/FmUpdateManager;->mIsSubUpdate:Z
...
.method public onUpdateApk(Ljava/lang/String;)Z
    ...
    .line 270
    iget-object v4, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;

    invoke-virtual {v4, v6}, Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;->show(Z)V

    .line 271
    iput v7, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_nProgressStatus:I

    .line 273
    iget-object v4, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;
    ...
    const-class v5, Lcom/infraware/filemanager/FmUpdateService;

    invoke-direct {v0, v4, v5}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    .line 281
    .local v0, bindIntent:Landroid/content/Intent;
    iget-boolean v4, p0, Lcom/infraware/filemanager/FmUpdateManager;->mIsSubUpdate:Z
    ...
    iget-object v5, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strSubUpdateURL:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/infraware/filemanager/FmUpdateManager;->mConnection:Landroid/content/ServiceConnection;

    invoke-virtual {v4, v0, v5, v6}, Landroid/app/Activity;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    iget-object v5, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strUpdateURL:Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/infraware/filemanager/FmUpdateManager;->onStopService(I)Z
...
.method public showError(I)V
    ...
    .line 357
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oSettingActivityHandler:Landroid/os/Handler;
...
.method public startUpdate()V
    ...
    .line 205
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oNetworkConfirmMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;

    invoke-virtual {v1}, Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;->isVisiable()Z

    move-result v1

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oProgressDlg:Lcom/infraware/uxcontrol/uicontrol/common/UiProgressDialog;
    ...
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oNetworkErrorMsgDialog:Lcom/infraware/uxcontrol/uicontrol/UiMessageDialog;
    ...
    .line 207
    :cond_1
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oUpdateBinder:Lcom/infraware/filemanager/FmUpdateService;
    ...
    invoke-virtual {v1}, Lcom/infraware/filemanager/FmUpdateService;->isAliveUpdateThread()Z
    ...
    .line 209
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oToast:Landroid/widget/Toast;
    ...
    iput-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oToast:Landroid/widget/Toast;
    ...
    invoke-static {v1}, Lcom/infraware/uxcontrol/uicontrol/common/UiNetworkConnection;->getNetworkConnectionInfo(Landroid/app/Activity;)I
    ...
    .line 227
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oHandler:Landroid/os/Handler;
    ...
    .line 228
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_strVersion:Ljava/lang/String;

    invoke-virtual {p0, v1}, Lcom/infraware/filemanager/FmUpdateManager;->onUpdateApk(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/infraware/filemanager/FmUpdateManager;->showError(I)V
    ...
    iput-boolean v3, v1, Lcom/infraware/filemanager/FmUpdateService;->mThreadStatus:Z

    .line 234
    iget-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oActivity:Landroid/app/Activity;

    iget-object v2, p0, Lcom/infraware/filemanager/FmUpdateManager;->mConnection:Landroid/content/ServiceConnection;
    ...
    iput-object v1, p0, Lcom/infraware/filemanager/FmUpdateManager;->m_oUpdateBinder:Lcom/infraware/filemanager/FmUpdateService;

...
.method static constructor <clinit>()V
    ...
    const-string v8, "http://schemas.google.com/g/2005#work"

    const-string v7, "http://schemas.google.com/g/2005#other"
...
.method protected handleExtraElementInEntry(Lcom/google/wireless/gdata/data/Entry;)V
    ...
    instance-of v0, v0, Lcom/google/wireless/gdata/contacts/data/ContactEntry;
    ...
    const-string v17, "Expected ContactEntry!"
    ...
    .line 182
    .local v3, contactEntry:Lcom/google/wireless/gdata/contacts/data/ContactEntry;
    ...
    .line 184
    new-instance v4, Lcom/google/wireless/gdata/contacts/data/EmailAddress;

    invoke-direct {v4}, Lcom/google/wireless/gdata/contacts/data/EmailAddress;-><init>()V

    .line 185
    .local v4, emailAddress:Lcom/google/wireless/gdata/contacts/data/EmailAddress;
    sget-object v16, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->REL_TO_TYPE_EMAIL:Ljava/util/Hashtable;
    ...
    invoke-static {v0, v1, v2}, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->parseContactsElement(Lcom/google/wireless/gdata/contacts/data/ContactsElement;Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Hashtable;)V

    .line 187
    invoke-virtual {v4}, Lcom/google/wireless/gdata/contacts/data/EmailAddress;->getType()B
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/EmailAddress;->setType(B)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/EmailAddress;->setIsPrimary(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/EmailAddress;->setLabel(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/EmailAddress;->setAddress(Ljava/lang/String;)V

    .line 193
    invoke-virtual {v3, v4}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->addEmailAddress(Lcom/google/wireless/gdata/contacts/data/EmailAddress;)V

    .line 244
    .end local v4           #emailAddress:Lcom/google/wireless/gdata/contacts/data/EmailAddress;
    :cond_2
    :goto_0
    return-void
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->setDeleted(Z)V
    ...
    .line 197
    new-instance v7, Lcom/google/wireless/gdata/contacts/data/ImAddress;

    invoke-direct {v7}, Lcom/google/wireless/gdata/contacts/data/ImAddress;-><init>()V

    .line 198
    .local v7, imAddress:Lcom/google/wireless/gdata/contacts/data/ImAddress;
    sget-object v16, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->REL_TO_TYPE_IM:Ljava/util/Hashtable;
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/ImAddress;->setAddress(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/ImAddress;->setLabel(Ljava/lang/String;)V
    ...
    .line 202
    .local v14, protocolString:Ljava/lang/String;
    if-nez v14, :cond_5
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/ImAddress;->setProtocolPredefined(B)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/ImAddress;->setProtocolCustom(Ljava/lang/String;)V

    .line 215
    :goto_1
    invoke-virtual {v3, v7}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->addImAddress(Lcom/google/wireless/gdata/contacts/data/ImAddress;)V

    goto :goto_0

    .line 206
    :cond_5
    sget-object v16, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->IM_PROTOCOL_STRING_TO_TYPE_MAP:Ljava/util/Hashtable;
    ...
    .line 207
    .local v13, predefinedProtocol:Ljava/lang/Byte;
    if-nez v13, :cond_6
    ...
    .line 209
    invoke-virtual {v7, v14}, Lcom/google/wireless/gdata/contacts/data/ImAddress;->setProtocolCustom(Ljava/lang/String;)V
    ...
    .line 216
    .end local v7           #imAddress:Lcom/google/wireless/gdata/contacts/data/ImAddress;
    .end local v13           #predefinedProtocol:Ljava/lang/Byte;
    .end local v14           #protocolString:Ljava/lang/String;
    :cond_7
    const-string v16, "postalAddress"
    ...
    .line 217
    new-instance v12, Lcom/google/wireless/gdata/contacts/data/PostalAddress;

    invoke-direct {v12}, Lcom/google/wireless/gdata/contacts/data/PostalAddress;-><init>()V

    .line 218
    .local v12, postalAddress:Lcom/google/wireless/gdata/contacts/data/PostalAddress;
    sget-object v16, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->REL_TO_TYPE_POSTAL:Ljava/util/Hashtable;
    ...
    .line 219
    invoke-static {v10}, Lcom/google/wireless/gdata/data/XmlUtils;->extractChildText(Lorg/xmlpull/v1/XmlPullParser;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/PostalAddress;->setValue(Ljava/lang/String;)V

    .line 220
    invoke-virtual {v3, v12}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->addPostalAddress(Lcom/google/wireless/gdata/contacts/data/PostalAddress;)V

    goto/16 :goto_0

    .line 221
    .end local v12           #postalAddress:Lcom/google/wireless/gdata/contacts/data/PostalAddress;
    :cond_8
    ...
    .line 222
    new-instance v11, Lcom/google/wireless/gdata/contacts/data/PhoneNumber;

    invoke-direct {v11}, Lcom/google/wireless/gdata/contacts/data/PhoneNumber;-><init>()V

    .line 223
    .local v11, phoneNumber:Lcom/google/wireless/gdata/contacts/data/PhoneNumber;
    sget-object v16, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->REL_TO_TYPE_PHONE:Ljava/util/Hashtable;
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/PhoneNumber;->setPhoneNumber(Ljava/lang/String;)V

    .line 225
    invoke-virtual {v3, v11}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->addPhoneNumber(Lcom/google/wireless/gdata/contacts/data/PhoneNumber;)V

    goto/16 :goto_0

    .line 226
    .end local v11           #phoneNumber:Lcom/google/wireless/gdata/contacts/data/PhoneNumber;
    :cond_9
    const-string v16, "organization"
    ...
    .line 227
    new-instance v9, Lcom/google/wireless/gdata/contacts/data/Organization;

    invoke-direct {v9}, Lcom/google/wireless/gdata/contacts/data/Organization;-><init>()V

    .line 228
    .local v9, organization:Lcom/google/wireless/gdata/contacts/data/Organization;
    sget-object v16, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->REL_TO_TYPE_ORGANIZATION:Ljava/util/Hashtable;
    ...
    .line 229
    invoke-static {v9, v10}, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->handleOrganizationSubElement(Lcom/google/wireless/gdata/contacts/data/Organization;Lorg/xmlpull/v1/XmlPullParser;)V

    .line 230
    invoke-virtual {v3, v9}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->addOrganization(Lcom/google/wireless/gdata/contacts/data/Organization;)V

    goto/16 :goto_0

    .line 231
    .end local v9           #organization:Lcom/google/wireless/gdata/contacts/data/Organization;
    :cond_a
    const-string v16, "extendedProperty"
    ...
    .line 232
    new-instance v5, Lcom/google/wireless/gdata/data/ExtendedProperty;

    invoke-direct {v5}, Lcom/google/wireless/gdata/data/ExtendedProperty;-><init>()V

    .line 233
    .local v5, extendedProperty:Lcom/google/wireless/gdata/data/ExtendedProperty;
    move-object/from16 v0, p0

    move-object v1, v5

    invoke-direct {v0, v1}, Lcom/google/wireless/gdata/contacts/parser/xml/XmlContactsGDataParser;->parseExtendedProperty(Lcom/google/wireless/gdata/data/ExtendedProperty;)V

    .line 234
    invoke-virtual {v3, v5}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->addExtendedProperty(Lcom/google/wireless/gdata/data/ExtendedProperty;)V

    goto/16 :goto_0

    .line 235
    .end local v5           #extendedProperty:Lcom/google/wireless/gdata/data/ExtendedProperty;
    :cond_b
    const-string v16, "groupMembershipInfo"
    ...
    .line 236
    new-instance v6, Lcom/google/wireless/gdata/contacts/data/GroupMembershipInfo;

    invoke-direct {v6}, Lcom/google/wireless/gdata/contacts/data/GroupMembershipInfo;-><init>()V

    .line 237
    .local v6, group:Lcom/google/wireless/gdata/contacts/data/GroupMembershipInfo;
    const/16 v16, 0x0
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/GroupMembershipInfo;->setGroup(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/wireless/gdata/contacts/data/GroupMembershipInfo;->setDeleted(Z)V

    .line 239
    invoke-virtual {v3, v6}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->addGroup(Lcom/google/wireless/gdata/contacts/data/GroupMembershipInfo;)V

    goto/16 :goto_0

    .line 240
    .end local v6           #group:Lcom/google/wireless/gdata/contacts/data/GroupMembershipInfo;
    :cond_c
    const-string v16, "yomiName"
    ...
    .line 242
    .local v15, yomiName:Ljava/lang/String;
    invoke-virtual {v3, v15}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->setYomiName(Ljava/lang/String;)V
...
.method protected handleExtraLinkInEntry(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/google/wireless/gdata/data/Entry;)V
    ...
    .prologue
    .line 249
    const-string v2, "http://schemas.google.com/contacts/2008/rel#photo"
    ...
    invoke-virtual {v1, p3, p2}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->setLinkPhoto(Ljava/lang/String;Ljava/lang/String;)V

    .line 256
    .end local v1           #contactEntry:Lcom/google/wireless/gdata/contacts/data/ContactEntry;
    :cond_0
    :goto_0
    return-void
    ...
    .line 252
    :cond_1
    const-string v2, "http://schemas.google.com/contacts/2008/rel#edit-photo"
    ...
    .line 254
    .restart local v1       #contactEntry:Lcom/google/wireless/gdata/contacts/data/ContactEntry;
    invoke-virtual {v1, p3, p2}, Lcom/google/wireless/gdata/contacts/data/ContactEntry;->setLinkEditPhoto(Ljava/lang/String;Ljava/lang/String;)V

...
.method private static findJarServiceProviderName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 548
    const-class v9, Lorg/apache/xml/dtm/ObjectFactory;
...
.method static lookUpFactoryClassName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 265
    .local v4, ss:Lorg/apache/xml/dtm/SecuritySupport;
    :try_start_4
    invoke-virtual {v4, p0}, Lorg/apache/xml/dtm/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lorg/apache/xml/dtm/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    :try_end_20
    ...
    invoke-virtual {v4, p2}, Lorg/apache/xml/dtm/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_58
    invoke-virtual {v4, p2}, Lorg/apache/xml/dtm/SecuritySupport;->getFileExists(Ljava/io/File;)Z
    :try_end_5b
    ...
    :try_start_63
    sget-wide v6, Lorg/apache/xml/dtm/ObjectFactory;->fLastModified:J
    ...
    invoke-virtual {v4, v2}, Lorg/apache/xml/dtm/SecuritySupport;->getLastModified(Ljava/io/File;)J

    move-result-wide v8

    sput-wide v8, Lorg/apache/xml/dtm/ObjectFactory;->fLastModified:J
    :try_end_75
    ...
    sput-object v3, Lorg/apache/xml/dtm/ObjectFactory;->fXalanProperties:Ljava/util/Properties;

    .line 321
    invoke-virtual {v4, v2}, Lorg/apache/xml/dtm/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;

    move-result-object p2

    .line 322
    sget-object v2, Lorg/apache/xml/dtm/ObjectFactory;->fXalanProperties:Ljava/util/Properties;
    ...
    .line 342
    sget-object p2, Lorg/apache/xml/dtm/ObjectFactory;->fXalanProperties:Ljava/util/Properties;
    ...
    invoke-static {p0}, Lorg/apache/xml/dtm/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    ...
    sput-wide v5, Lorg/apache/xml/dtm/ObjectFactory;->fLastModified:J

    .line 291
    const/4 p2, 0x0

    sput-object p2, Lorg/apache/xml/dtm/ObjectFactory;->fXalanProperties:Ljava/util/Properties;
    ...
    :try_start_d0
    sput-wide v6, Lorg/apache/xml/dtm/ObjectFactory;->fLastModified:J
    ...
    :try_start_d8
    sput-object v2, Lorg/apache/xml/dtm/ObjectFactory;->fXalanProperties:Ljava/util/Properties;

    .line 326
    .end local v2           #x:Ljava/lang/Exception;
    const-wide/16 v2, -0x1

    sput-wide v2, Lorg/apache/xml/dtm/ObjectFactory;->fLastModified:J
    :try_end_de
    ...
    invoke-virtual {v4, v1}, Lorg/apache/xml/dtm/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    :try_end_107
    ...
    .local p2, factoryClassName:Ljava/lang/String;
    :cond_132
    invoke-static {p0}, Lorg/apache/xml/dtm/ObjectFactory;->findJarServiceProviderName(Ljava/lang/String;)Ljava/lang/String;

...
.method dequeue()V
    ...
    .local v0, out:Z
    :goto_b
    iget-object v1, p0, Landroid/hardware/usb/UsbRequest;->mBuffer:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, p0, Landroid/hardware/usb/UsbRequest;->mBuffer:Ljava/nio/ByteBuffer;
    ...
    iget v2, p0, Landroid/hardware/usb/UsbRequest;->mLength:I

    invoke-direct {p0, v1, v2, v0}, Landroid/hardware/usb/UsbRequest;->native_dequeue_array([BIZ)V

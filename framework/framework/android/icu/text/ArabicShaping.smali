...
.method public constructor <init>(I)V
    ...
    :goto_25
    iput-boolean v0, p0, Landroid/icu/text/ArabicShaping;->spacesRelativeToTextBeginEnd:Z
...
.method private expandCompositChar([CIIII)I
    ...
    iget v0, v0, Landroid/icu/text/ArabicShaping;->options:I
    ...
    const/high16 v3, 0x70

    and-int v11, v2, v3

    .line 1505
    .local v11, lenOptionsSeen:I
    move-object/from16 v0, p0
    ...
    const/high16 v3, 0x380

    and-int v12, v2, v3

    .line 1506
    .local v12, lenOptionsYehHamza:I
    const/4 v14, 0x0

    .line 1508
    .local v14, spaceNotFound:Z
    move-object/from16 v0, p0

    iget-boolean v0, v0, Landroid/icu/text/ArabicShaping;->isLogical:Z
    ...
    iget-boolean v0, v0, Landroid/icu/text/ArabicShaping;->spacesRelativeToTextBeginEnd:Z
    ...
    invoke-direct/range {v2 .. v8}, Landroid/icu/text/ArabicShaping;->expandCompositCharAtNear([CIIIII)Z
    ...
    .line 1527
    new-instance v2, Landroid/icu/text/ArabicShaping$ArabicShapingException;

    const-string v3, "No spacefor lamalef"

    invoke-direct {v2, v3}, Landroid/icu/text/ArabicShaping$ArabicShapingException;-><init>(Ljava/lang/String;)V
    ...
    .line 1559
    .local v9, ch:C
    invoke-static {v9}, Landroid/icu/text/ArabicShaping;->isNormalizedLamAlefChar(C)Z
    ...
    sget-object v2, Landroid/icu/text/ArabicShaping;->convertNormalizedLamAlef:[C
    ...
    const-string v3, "No space for Seen tail expansion"
    ...
    const-string v3, "No space for YehHamza expansion"
...
.method private internalShape([CII[CII)I
    ...
    .line 1827
    iget v5, p0, Landroid/icu/text/ArabicShaping;->options:I
    ...
    .line 1830
    invoke-direct/range {p0 .. p3}, Landroid/icu/text/ArabicShaping;->calculateSize([CII)I
    ...
    .line 1840
    iget-boolean v5, p0, Landroid/icu/text/ArabicShaping;->isLogical:Z
    ...
    invoke-static {v0, v1, v2}, Landroid/icu/text/ArabicShaping;->invertBuffer([CII)V
    ...
    .line 1876
    new-instance v5, Landroid/icu/text/ArabicShaping$ArabicShapingException;

    const-string v6, "not enough room for result data"

    .end local v6           #temp:[C
    invoke-direct {v5, v6}, Landroid/icu/text/ArabicShaping$ArabicShapingException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct/range {v5 .. v10}, Landroid/icu/text/ArabicShaping;->shapeUnicode([CIIII)I

    .end local v8           #outputSize:I
    move-result v8

    .line 1849
    .restart local v8       #outputSize:I
    goto :goto_41
    ...
    invoke-static {v0, v1}, Landroid/icu/text/ArabicShaping;->handleTashkeelWithTatweel([CI)I
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Landroid/icu/text/ArabicShaping;->deShapeUnicode([CIII)I
    ...
    invoke-static {v6, v5, v8}, Landroid/icu/text/ArabicShaping;->invertBuffer([CII)V
    ...
    if-gt v11, v5, :cond_e8

    const/16 v5, 0x30

    if-lt v11, v5, :cond_e8
    ...
    .line 1910
    .local v13, digitTop:C
    const/16 v5, 0x30

    sub-int v12, v5, v9

    .line 1911
    .restart local v12       #digitDelta:I
    const/4 v14, 0x0
    ...
    if-gt v11, v13, :cond_101

    if-lt v11, v9, :cond_101
    ...
    invoke-direct/range {v5 .. v10}, Landroid/icu/text/ArabicShaping;->shapeToArabicDigitsWithContext([CIICZ)V
...
.method private shapeUnicode([CIIII)I
    ...
    .line 1661
    .local v6, lamalef_count:I
    const/4 v11, 0x0

    .local v11, lamalef_found:Z
    const/16 v18, 0x0

    .line 1662
    .local v18, seenfam_found:Z
    const/16 v22, 0x0

    .local v22, yehhamza_found:Z
    const/16 v20, 0x0

    .line 1663
    .local v20, tashkeel_found:Z
    add-int v2, p2, p3
    ...
    invoke-static {v2}, Landroid/icu/text/ArabicShaping;->getLink(C)I
    ...
    .line 1666
    .local v14, nextLink:I
    const/16 v17, 0x0

    .line 1667
    .local v17, prevLink:I
    const/4 v12, 0x0

    .line 1669
    .local v12, lastLink:I
    move v13, v10
    ...
    invoke-static {v2}, Landroid/icu/text/ArabicShaping;->isTashkeelChar(C)Z
    ...
    invoke-static {v2}, Landroid/icu/text/ArabicShaping;->changeLamAlef(C)C

    move-result v21

    .line 1695
    .local v21, wLamalef:C
    if-eqz v21, :cond_66
    ...
    .line 1703
    invoke-static/range {v21 .. v21}, Landroid/icu/text/ArabicShaping;->getLink(C)I

    move-result v8

    .line 1705
    .end local v21           #wLamalef:C
    :cond_6c
    if-lez v10, :cond_c8
    ...
    invoke-static {v2}, Landroid/icu/text/ArabicShaping;->isSeenFamilyChar(C)I
    ...
    invoke-static {v2}, Landroid/icu/text/ArabicShaping;->specialChar(C)I

    move-result v9

    .line 1728
    .local v9, flag:I
    sget-object v2, Landroid/icu/text/ArabicShaping;->shapeTable:[[[I
    ...
    sget-object v3, Landroid/icu/text/ArabicShaping;->irrelevantPos:[I
    ...
    invoke-direct/range {v2 .. v7}, Landroid/icu/text/ArabicShaping;->expandCompositChar([CIIII)I

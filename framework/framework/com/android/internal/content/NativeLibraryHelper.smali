...
.method public static copyNativeBinariesLI(Ljava/io/File;Ljava/io/File;)I
    ...
    :try_end_30
    .catch Ljava/util/zip/ZipException; {:try_start_0 .. :try_end_30} :catch_32
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_30} :catch_3d
    ...
    const-string v8, "Failed to extract data from package file"
    ...
    const-string v8, "Failed to cache package shared libs"
...
.method private static copyNativeBinaryLI(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/io/File;)V
    ...
    throw v3
    :try_end_58
    .catchall {:try_start_4 .. :try_end_58} :catchall_58

...
.method public constructor <init>(Landroid/content/Context;Lcom/android/phone/InCallScreen;Landroid/view/ViewGroup;Lcom/android/phone/CallCard;Lcom/android/phone/DTMFTwelveKeyDialer;)V
    ...
    .line 157
    iput-boolean v3, p0, Lcom/android/phone/OtaUtils;->mInteractive:Z
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/phone/OtaUtils;->mInteractive:Z
    ...
    .line 212
    .end local v0           #otaCallCardStub:Landroid/view/ViewStub;
    :cond_0
    return-void
...
.method private static isCdmaPhone()Z
    .locals 2
...
.method public static maybeDoOtaCall(Landroid/content/Context;Landroid/os/Handler;I)Z
    ...
    const-string v1, "Don\'t run provisioning when in test harness"
    ...
    .line 245
    invoke-interface {v1}, Lcom/android/internal/telephony/Phone;->needsOtaServiceProvisioning()Z
    ...
    .line 264
    const-string v0, "maybeDoOtaCall: voice capable; activation intent sent."
    ...
    .line 266
    :cond_3
    const-string v0, "maybeDoOtaCall: voice capable; activation intent NOT sent."
    ...
    const-string v1, "com.android.phone.PERFORM_VOICELESS_CDMA_PROVISIONING"
    ...
    .line 273
    const-string v1, "com.android.phone.VOICELESS_PROVISIONING_OFFER_DONTSHOW"
    ...
    .line 275
    const-string v0, "maybeDoOtaCall: non-interactive; activation intent sent."
    ...
    .line 277
    :cond_5
    const-string v0, "maybeDoOtaCall: non-interactive, no need for OTASP."
...
.method public static startNonInteractiveOtasp(Landroid/content/Context;)I
    ...
    iget-object v0, v9, Lcom/android/phone/PhoneApp;->otaUtils:Lcom/android/phone/OtaUtils;
    ...
    const-string v1, "startNonInteractiveOtasp: OtaUtils already exists; nuking the old one and starting again..."
    ...
    iput-object v0, v9, Lcom/android/phone/PhoneApp;->otaUtils:Lcom/android/phone/OtaUtils;
    ...
    const-string v1, "- created OtaUtils: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, v9, Lcom/android/phone/PhoneApp;->otaUtils:Lcom/android/phone/OtaUtils;
    ...
    const-string v1, "  ==> successful return from placeCall(): callStatus = "
    ...
    const-string v2, "Failure from placeCall() for OTA number \'"
...
.method public onOtaProvisionStatusChanged(Landroid/os/AsyncResult;)V
    ...
    const-string v2, "Provision status event!"
    ...
    const-string v3, "onOtaProvisionStatusChanged(): status = "
    ...
    invoke-static {v3}, Lcom/android/phone/OtaUtils;->otaProvisionStatusToString(I)Ljava/lang/String;
    ...
    .line 387
    iget-boolean v2, p0, Lcom/android/phone/OtaUtils;->mInteractive:Z
    ...
    invoke-direct {p0, v2}, Lcom/android/phone/OtaUtils;->sendOtaspResult(I)V

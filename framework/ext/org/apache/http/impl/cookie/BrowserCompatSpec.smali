...
.method public parse(Lorg/apache/http/Header;Lorg/apache/http/cookie/CookieOrigin;)Ljava/util/List;
    ...
    const-string v13, "Header may not be null"
    ...
    const-string v13, "Cookie origin may not be null"
    ...
    invoke-static {v12, v13}, Lorg/apache/http/impl/cookie/DateUtils;->parseDate(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Date;
    :try_end_48
    .catch Lorg/apache/http/impl/cookie/DateParseException; {:try_start_3c .. :try_end_48} :catch_a9
    ...
    .line 129
    sget-object v10, Lorg/apache/http/impl/cookie/NetscapeDraftHeaderParser;->DEFAULT:Lorg/apache/http/impl/cookie/NetscapeDraftHeaderParser;

    .line 132
    .local v10, parser:Lorg/apache/http/impl/cookie/NetscapeDraftHeaderParser;
    ...
    invoke-interface {v12}, Lorg/apache/http/FormattedHeader;->getBuffer()Lorg/apache/http/util/CharArrayBuffer;
    ...
    invoke-direct {v4, v12, v13}, Lorg/apache/http/message/ParserCursor;-><init>(II)V
    ...
    new-array v5, v12, [Lorg/apache/http/HeaderElement;

    .end local v5           #elems:[Lorg/apache/http/HeaderElement;
    invoke-virtual {v10, v3, v4}, Lorg/apache/http/impl/cookie/NetscapeDraftHeaderParser;->parseHeader(Lorg/apache/http/util/CharArrayBuffer;Lorg/apache/http/message/ParserCursor;)Lorg/apache/http/HeaderElement;
    ...
    .end local v10           #parser:Lorg/apache/http/impl/cookie/NetscapeDraftHeaderParser;
    ...
    .line 138
    .restart local v10       #parser:Lorg/apache/http/impl/cookie/NetscapeDraftHeaderParser;
    .restart local p1
    :cond_80
    invoke-interface/range {p1 .. p1}, Lorg/apache/http/Header;->getValue()Ljava/lang/String;
    ...
    .line 140
    new-instance v12, Lorg/apache/http/cookie/MalformedCookieException;

    const-string v13, "Header value is null"

    invoke-direct {v12, v13}, Lorg/apache/http/cookie/MalformedCookieException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v3, v12}, Lorg/apache/http/util/CharArrayBuffer;-><init>(I)V

    .line 143
    .restart local v3       #buffer:Lorg/apache/http/util/CharArrayBuffer;
    invoke-virtual {v3, v11}, Lorg/apache/http/util/CharArrayBuffer;->append(Ljava/lang/String;)V
    ...
    invoke-direct {v4, v15, v12}, Lorg/apache/http/message/ParserCursor;-><init>(II)V
